...
/***/ "./apps/service-voucher/src/category/entities/category.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


var Category_1, _a, _b, _c;
...
const rule_1 = __webpack_require__("./apps/service-voucher/src/rule/entities/rule.ts");
const repository_1 = __webpack_require__("./apps/service-voucher/src/category/repository.ts");
let Category = Category_1 = class Category extends service_sdk_1.BaseEntity {
    constructor() {
        super(...arguments);
        this.sub_categories = new core_1.Collection(this);
...
tslib_1.__decorate([
    core_1.Property({ type: core_1.DateType, columnType: "date", nullable: true }),
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_c = typeof core_1.Collection !== "undefined" && core_1.Collection) === "function" ? _c : Object)
], Category.prototype, "sub_categories", void 0);
tslib_1.__decorate([
    core_1.ManyToMany(() => rule_1.default, (rule) => rule.categories, { pivotTable: "rule_category" }),
...
Category = Category_1 = tslib_1.__decorate([
    ...
    core_1.Entity({ tableName: "category", customRepository: () => repository_1.CategoryRepository })
], Category);
...
/***/ "./apps/service-voucher/src/category/repository.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "./apps/service-voucher/src/category/route.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
const usecases_1 = __webpack_require__("./apps/service-voucher/src/category/usecases/index.ts");
const router = express.Router();
router.get("/api/voucher/categories", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const [data, count] = yield usecases_1.default({ conn: req.conn, validate: false, tenant: req.tenant }).listCategories();
...
/***/ "./apps/service-voucher/src/category/usecases/index.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
const list_categories_1 = __webpack_require__("./apps/service-voucher/src/category/usecases/list-categories.ts");
const category_1 = __webpack_require__("./apps/service-voucher/src/category/entities/category.ts");
...
/***/ "./apps/service-voucher/src/category/usecases/list-categories.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = (dependency) => {
    ...
    return () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        return categoryRepository.findAndCount({ parent_category: null }, { populate: ["sub_categories"], filters: ["ongoing"] });
    });
};
...
/***/ "./apps/service-voucher/src/code/entities/code.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const core_1 = __webpack_require__("@mikro-orm/core");
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
const hotel_1 = __webpack_require__("./apps/service-voucher/src/hotel/entities/hotel.ts");
const program_1 = __webpack_require__("./apps/service-voucher/src/program/entities/program.ts");
var CodeStatus;
(function (CodeStatus) {
    CodeStatus["PENDING"] = "PENDING";
    CodeStatus["REDEEMED"] = "REDEEMED";
})(CodeStatus = exports.CodeStatus || (exports.CodeStatus = {}));
let Code = class Code extends service_sdk_1.BaseEntity {
};
tslib_1.__decorate([
    core_1.Property(),
    tslib_1.__metadata("design:type", String)
...
tslib_1.__decorate([
    core_1.ManyToOne(),
    tslib_1.__metadata("design:type", typeof (_a = typeof program_1.default !== "undefined" && program_1.default) === "function" ? _a : Object)
], Code.prototype, "program", void 0);
tslib_1.__decorate([
    core_1.Property({ nullable: true }),
    tslib_1.__metadata("design:type", Number)
], Code.prototype, "order_id", void 0);
tslib_1.__decorate([
    core_1.ManyToOne(),
    tslib_1.__metadata("design:type", typeof (_b = typeof hotel_1.default !== "undefined" && hotel_1.default) === "function" ? _b : Object)
], Code.prototype, "hotel", void 0);
tslib_1.__decorate([
    core_1.Property({ nullable: true }),
    tslib_1.__metadata("design:type", Number)
], Code.prototype, "amount_used", void 0);
tslib_1.__decorate([
    core_1.Property({ nullable: true }),
    core_1.Unique(),
    tslib_1.__metadata("design:type", Number)
], Code.prototype, "oms_id", void 0);
tslib_1.__decorate([
    core_1.Property({ nullable: true }),
    tslib_1.__metadata("design:type", typeof (_c = typeof Date !== "undefined" && Date) === "function" ? _c : Object)
], Code.prototype, "claimed_date", void 0);
Code = tslib_1.__decorate([
    core_1.Entity({ tableName: "code", customRepository: () => service_sdk_1.CustomEntityRepository }),
    core_1.Filter({
        name: "filterCodes",
        cond: (args) => ({
            $and: [
                Object.assign({}, (args.type && { program: { type: { $in: args.type } } })),
                Object.assign({}, (args.status && { claimed_date: args.status === CodeStatus.PENDING ? { $eq: null } : { $ne: null } })),
                Object.assign({}, (args.fromDate && { created_at: { $gte: args.fromDate } })),
                Object.assign({}, (args.toDate && { created_at: { $lt: args.toDate } })),
                {
                    $or: [
                        Object.assign({}, (args.name && { program: { name: { $ilike: args.name } } })),
                        Object.assign({}, (args.name && { code: { $ilike: args.name } }))
                    ]
                }
            ]
        })
...
/***/ "./apps/service-voucher/src/code/route.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const express = __webpack_require__("express");
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
const usecases_1 = __webpack_require__("./apps/service-voucher/src/code/usecases/index.ts");
const code_1 = __webpack_require__("./apps/service-voucher/src/code/entities/code.ts");
const shared_1 = __webpack_require__("./libs/shared/index.ts");
const router = express.Router();
router.get("/codes/:hotelId", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        let types;
        let fromDate;
        ...
        if ((_a = req.query) === null || _a === void 0 ? void 0 : _a.fromDate) {
            fromDate = new Date(req.query.fromDate);
        }
        if ((_b = req.query) === null || _b === void 0 ? void 0 : _b.toDate) {
            toDate = new Date(req.query.toDate);
        }
        if ((fromDate && fromDate.toString() === "Invalid Date") || (toDate && toDate.toString() === "Invalid Date")) {
            throw new service_sdk_1.BadRequestError("Invalid dates provided");
        }
        const filters = Object.assign({ programTypes: types && types.map((type) => shared_1.VoucherType[type]), name: req.query.name, fromDate,
            toDate, status: code_1.CodeStatus[req.query.status] }, service_sdk_1.parsePaginationParam(req.query));
        const [data, count] = yield usecases_1.default({ conn: req.conn, validate: false, tenant: req.tenant }).getCodes(filters, Number(req.params.hotelId));
        return res.send(service_sdk_1.httpResponse({
            payload: data,
...
router.get("/code/:code", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
...
/***/ "./apps/service-voucher/src/code/usecases/get-by-code.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CodeNotFound = void 0;
const tslib_1 = __webpack_require__("tslib");
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
class CodeNotFound extends service_sdk_1.NotFoundError {
    constructor() {
        super("Code", "Code not found");
    }
}
exports.CodeNotFound = CodeNotFound;
exports["default"] = (dependency) => {
    const { codeRepository } = dependency;
    return (codeFilter) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const code = yield codeRepository.getOneEntityOrFail({ code: { $ilike: codeFilter } }, ["program.rules.categories.parent_category"]);
        return Object.assign(Object.assign({}, code), { program: Object.assign({}, code.program) });
    });
};
...
/***/ "./apps/service-voucher/src/code/usecases/get-code.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "./apps/service-voucher/src/code/usecases/get-codes.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = (dependency) => {
    const { codeRepository } = dependency;
    return (filters, hotelId) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        var _a;
        let options = {};
        ...
        if (filters.status || filters.programTypes || filters.name || filters.fromDate || filters.toDate) {
            options = {
                filterCodes: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (filters.status && { status: filters.status })), (filters.programTypes && { type: filters.programTypes })), (name && { name: `%${name}%` })), (filters.fromDate && { fromDate: filters.fromDate })), (filters.toDate && { toDate: filters.toDate }))
            };
        }
        return codeRepository.findAndCount({ hotel: hotelId }, Object.assign(Object.assign(Object.assign({ filters: options }, ((filters === null || filters === void 0 ? void 0 : filters.page) && { offset: (filters.page - 1) * filters.limit })), ((filters === null || filters === void 0 ? void 0 : filters.limit) && { limit: filters.limit })), { populate: ["program"] }));
    });
};
...
/***/ "./apps/service-voucher/src/code/usecases/index.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
const code_1 = __webpack_require__("./apps/service-voucher/src/code/entities/code.ts");
const get_code_1 = __webpack_require__("./apps/service-voucher/src/code/usecases/get-code.ts");
const get_by_code_1 = __webpack_require__("./apps/service-voucher/src/code/usecases/get-by-code.ts");
const get_codes_1 = __webpack_require__("./apps/service-voucher/src/code/usecases/get-codes.ts");
exports["default"] = (dependency) => {
    const { conn } = dependency;
    return {
        getCode: get_code_1.default({
            codeRepository: conn.em.getRepository(code_1.default)
        }),
        getCodes: get_codes_1.default({
            codeRepository: conn.em.getRepository(code_1.default)
        }),
...
/***/ "./apps/service-voucher/src/entities.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.VoucherEntities = exports.VoucherEntitiesObject = void 0;
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
const program_1 = __webpack_require__("./apps/service-voucher/src/program/entities/program.ts");
const code_1 = __webpack_require__("./apps/service-voucher/src/code/entities/code.ts");
const rule_1 = __webpack_require__("./apps/service-voucher/src/rule/entities/rule.ts");
const hotel_1 = __webpack_require__("./apps/service-voucher/src/hotel/entities/hotel.ts");
const hub_1 = __webpack_require__("./apps/service-voucher/src/hub/entities/hub.ts");
const category_1 = __webpack_require__("./apps/service-voucher/src/category/entities/category.ts");
exports.VoucherEntitiesObject = {
    BaseEntity: service_sdk_1.BaseEntity,
    AuditBaseEntity: service_sdk_1.AuditBaseEntity,
    VoucherCategory: category_1.default,
    VoucherHub: hub_1.default,
    VoucherProgram: program_1.default,
    VoucherHotel: hotel_1.default,
    VoucherCode: code_1.default,
    VoucherRule: rule_1.default
};
exports.VoucherEntities = {
    asArray: () => {
        return Object.values(exports.VoucherEntitiesObject);
    },
    asObject: () => {
        return exports.VoucherEntitiesObject;
    }
};
...
/***/ "./apps/service-voucher/src/hotel/entities/hotel.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const program_1 = __webpack_require__("./apps/service-voucher/src/program/entities/program.ts");
const hub_1 = __webpack_require__("./apps/service-voucher/src/hub/entities/hub.ts");
const repository_1 = __webpack_require__("./apps/service-voucher/src/hotel/repository.ts");
let Hotel = class Hotel extends service_sdk_1.BaseEntity {
    constructor() {
        super(...arguments);
        this.active = true;
        this.programs = new core_1.Collection(this);
    }
    getProgramTypes() {
        const types = new Set();
...
tslib_1.__decorate([
    core_1.ManyToMany({
        entity: () => program_1.default,
        owner: true,
        pivotTable: "program_hotel"
    }),
    tslib_1.__metadata("design:type", typeof (_b = typeof core_1.Collection !== "undefined" && core_1.Collection) === "function" ? _b : Object)
], Hotel.prototype, "programs", void 0);
tslib_1.__decorate([
    core_1.Property({ persist: false }),
    tslib_1.__metadata("design:type", Array)
], Hotel.prototype, "program_types", void 0);
Hotel = tslib_1.__decorate([
    core_1.Entity({ tableName: "hotel", customRepository: () => repository_1.HotelRepository })
], Hotel);
...
/***/ "./apps/service-voucher/src/hotel/repository.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "./apps/service-voucher/src/hotel/route.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const express = __webpack_require__("express");
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
const usecases_1 = __webpack_require__("./apps/service-voucher/src/hotel/usecases/index.ts");
const shared_1 = __webpack_require__("./libs/shared/index.ts");
const router = express.Router();
router.get("/api/voucher/program-hotels", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        let type;
        if (Array.isArray(req.query.type) && req.query.type.length) {
            type = req.query.type;
        }
        const filters = Object.assign({ programType: type && type.map((filterType) => shared_1.VoucherType[filterType]), hotelName: req.query.name }, service_sdk_1.parsePaginationParam(req.query));
...
router.get("/api/voucher/hotels/:id", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield usecases_1.default({
            conn: req.conn,
            validate: !req.isValid,
...
router.get("/api/voucher/hotels", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const [data, count] = yield usecases_1.default({
            conn: req.conn,
            validate: !req.isValid,
            tenant: req.tenant
        }).getHotels(Object.assign(Object.assign({}, service_sdk_1.parsePaginationParam(req.query)), { name: req.query.search }));
        return res.send(service_sdk_1.httpResponse({
            payload: data,
            total: count || 0,
            nextPage: req.query.page ? Number(req.query.page) + 1 : 1
...
/***/ "./apps/service-voucher/src/hotel/usecases/get-hotel.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "./apps/service-voucher/src/hotel/usecases/get-list-hotels.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "./apps/service-voucher/src/hotel/usecases/get-program-hotels.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
const getHotelsWithProgramsQuery = (filter) => {
...
exports["default"] = (dependency) => {
    ...
    return (req) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const { text, values } = getHotelsWithProgramsQuery(req);
        const { rows } = yield knex.raw(text, values);
...
/***/ "./apps/service-voucher/src/hotel/usecases/index.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
const hotel_1 = __webpack_require__("./apps/service-voucher/src/hotel/entities/hotel.ts");
const get_program_hotels_1 = __webpack_require__("./apps/service-voucher/src/hotel/usecases/get-program-hotels.ts");
const get_hotel_1 = __webpack_require__("./apps/service-voucher/src/hotel/usecases/get-hotel.ts");
const get_list_hotels_1 = __webpack_require__("./apps/service-voucher/src/hotel/usecases/get-list-hotels.ts");
exports["default"] = (dependency) => {
    const { conn } = dependency;
    return {
        getProgramHotels: get_program_hotels_1.default({
            knex: conn.em.getKnex()
        }),
        getHotel: get_hotel_1.default({
            hotelRepository: conn.em.getRepository(hotel_1.default)
        }),
        getHotels: get_list_hotels_1.default({
            hotelRepository: conn.em.getRepository(hotel_1.default)
        })
    };
};
...
/***/ "./apps/service-voucher/src/hub/entities/hub.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const core_1 = __webpack_require__("@mikro-orm/core");
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
const repository_1 = __webpack_require__("./apps/service-voucher/src/hub/repository.ts");
const hotel_1 = __webpack_require__("./apps/service-voucher/src/hotel/entities/hotel.ts");
...
/***/ "./apps/service-voucher/src/hub/repository.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "./apps/service-voucher/src/listeners/voucher-on-category-action.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.categoryEvents = void 0;
const tslib_1 = __webpack_require__("tslib");
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
const core_1 = __webpack_require__("@mikro-orm/core");
const shared_1 = __webpack_require__("./libs/shared/index.ts");
const category_1 = __webpack_require__("./apps/service-voucher/src/category/entities/category.ts");
const entities_1 = __webpack_require__("./apps/service-voucher/src/entities.ts");
const categoryEvents = (categoryRepository) => {
    const categoryCreated = (context, data) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const category = categoryRepository.create(data);
        yield categoryRepository.persistAndFlush(category);
    });
    const categoryUpdated = (context, data) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const existingCategory = yield categoryRepository.getOneEntityOrFail(data.id);
        core_1.wrap(existingCategory).assign(data);
        yield categoryRepository.flush();
    });
    const categoryDeleted = (context, data) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield categoryRepository.softDelete(data.id);
        yield categoryRepository.flush();
    });
    return {
        categoryCreated,
...
exports.categoryEvents = categoryEvents;
function voucherOnCategoryAction(event) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const { conn: { em } } = yield service_sdk_1.getConnection({
            ...
            entities: entities_1.VoucherEntities.asArray(),
            pooling: false,
            subscribers: []
        });
        const categoryRepository = em.getRepository(category_1.default);
        for (const record of event.Records) {
            ...
            switch (messageAttributes.eventName.StringValue || messageAttributes.eventName.stringValue) {
                case shared_1.CATEGORY_EVENT.CREATED_ADAPTER:
                    service_sdk_1.logger.log("category create event sent to adapter");
                    break;
                case shared_1.CATEGORY_EVENT.CREATED:
                    yield exports.categoryEvents(categoryRepository).categoryCreated(context, data);
                    break;
                case shared_1.CATEGORY_EVENT.UPDATED:
                    yield exports.categoryEvents(categoryRepository).categoryUpdated(context, data);
                    break;
                case shared_1.CATEGORY_EVENT.DELETED:
                    yield exports.categoryEvents(categoryRepository).categoryDeleted(context, data);
                    break;
                default:
...
exports["default"] = voucherOnCategoryAction;


/***/ }),

/***/ "./apps/service-voucher/src/listeners/voucher-on-hotel-action.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.hotelEvents = void 0;
const tslib_1 = __webpack_require__("tslib");
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
const core_1 = __webpack_require__("@mikro-orm/core");
const shared_1 = __webpack_require__("./libs/shared/index.ts");
...
const hotelEvents = (hotelRepository, hubRepository) => {
    const hotelCreated = (context, data) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const hotel = hotelRepository.create(Object.assign(Object.assign({}, data), { hub: data.hub.id }));
        const existingHub = yield hubRepository.findOne(data.hub.id);
        if (!existingHub) {
    ...
    const hotelUpdated = (context, data) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const existingHotel = yield hotelRepository.getOneEntityOrFail(data.id);
        core_1.wrap(existingHotel).assign(constructHotelData(data));
        yield hotelRepository.flush();
    });
    const hotelDeleted = (context, data) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield hotelRepository.softDelete(data.id);
        yield hotelRepository.flush();
    });
    return {
        hotelCreated,
...
function voucherOnHotelAction(event) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        service_sdk_1.logger.log("event -> ", event);
        if (event.source === shared_1.warmupkey) {
            service_sdk_1.logger.log("WarmUP - Lambda is warm!");
            return;
        }
        ...
        for (const record of event.Records) {
            const bodyParsed = JSON.parse(record.body);
            const { context, data } = bodyParsed;
            service_sdk_1.logger.log(context, data);
            const messageAttributes = record.MessageAttributes || record.messageAttributes;
            switch (messageAttributes.eventName.StringValue || messageAttributes.eventName.stringValue) {
                ...
                case shared_1.HOTEL_EVENT.CREATED:
                    yield exports.hotelEvents(hotelRepository, hubRepository).hotelCreated(context, data);
                    break;
                case shared_1.HOTEL_EVENT.UPDATED:
                    yield exports.hotelEvents(hotelRepository).hotelUpdated(context, data);
                    break;
                case shared_1.HOTEL_EVENT.DELETED:
                    yield exports.hotelEvents(hotelRepository).hotelDeleted(context, data);
                    break;
                default:
                    throw new service_sdk_1.BadRequestError("Bad event name provided");
            }
...
exports["default"] = voucherOnHotelAction;


/***/ }),

/***/ "./apps/service-voucher/src/listeners/voucher-on-hub-action.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.hubEvents = void 0;
const tslib_1 = __webpack_require__("tslib");
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
const shared_1 = __webpack_require__("./libs/shared/index.ts");
const core_1 = __webpack_require__("@mikro-orm/core");
...
const hubEvents = (hubRepository) => {
    const hubCreated = (context, data) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const hub = hubRepository.create(data);
        yield hubRepository.persistAndFlush(hub);
    });
    const hubUpdated = (context, data) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const existingHub = yield hubRepository.getOneEntityOrFail(data.id);
        core_1.wrap(existingHub).assign(data);
        yield hubRepository.flush();
    });
    const hubDeleted = (context, data) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield hubRepository.softDelete(data.id);
        yield hubRepository.flush();
    });
    return {
        hubCreated,
...
exports.hubEvents = hubEvents;
function voucherOnHubAction(event) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        service_sdk_1.logger.log("event -> ", event);
        if (event.source === shared_1.warmupkey) {
            service_sdk_1.logger.log("WarmUP - Lambda is warm!");
        ...
        for (const record of event.Records) {
            ...
            switch (messageAttributes.eventName.StringValue || messageAttributes.eventName.stringValue) {
                ...
                case shared_1.HUB_EVENT.CREATED:
                    yield exports.hubEvents(hubRepository).hubCreated(context, data);
                    break;
                case shared_1.HUB_EVENT.UPDATED:
                    yield exports.hubEvents(hubRepository).hubUpdated(context, data);
                    break;
                case shared_1.HUB_EVENT.DELETED:
                    yield exports.hubEvents(hubRepository).hubDeleted(context, data);
                    break;
                default:
                    throw new service_sdk_1.BadRequestError("Bad event name provided");
            }
...
exports["default"] = voucherOnHubAction;


/***/ }),

/***/ "./apps/service-voucher/src/listeners/voucher-on-menu-assign-action.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const entities_1 = __webpack_require__("./apps/service-voucher/src/entities.ts");
const hotel_1 = __webpack_require__("./apps/service-voucher/src/hotel/entities/hotel.ts");
const menuEvents = (hotelRepository) => {
    const hotelsAssigned = (data) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const existingHotels = yield hotelRepository.find({ menu_id: data.id });
        ...
        const hotels = yield hotelRepository.getEntitiesOrFailIfNotFound(menuHotelIds);
        hotels.forEach((h) => {
            core_1.wrap(h).assign({ menu_id: data.id });
        });
        yield hotelRepository.flush();
    });
    return {
...
function voucherOnMenuAssignAction(event) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        if (event.source === shared_1.warmupkey) {
            service_sdk_1.logger.log("WarmUP - Lambda is warm!");
            return;
        ...
        for (const record of event.Records) {
            ...
            switch (messageAttributes.eventName.StringValue || messageAttributes.eventName.stringValue) {
                case shared_1.MENU_EVENT.HOTELS_ASSIGNED:
                    yield exports.menuEvents(hotelRepository).hotelsAssigned(data);
                    break;
                default:
                    throw new service_sdk_1.BadRequestError("Bad event name provided");
            }
...
exports["default"] = voucherOnMenuAssignAction;


/***/ }),

/***/ "./apps/service-voucher/src/main.ts":
...
// Routes
const shared_1 = __webpack_require__("./libs/shared/index.ts");
const route_1 = __webpack_require__("./apps/service-voucher/src/program/route.ts");
const route_2 = __webpack_require__("./apps/service-voucher/src/hotel/route.ts");
const route_3 = __webpack_require__("./apps/service-voucher/src/category/route.ts");
const route_4 = __webpack_require__("./apps/service-voucher/src/code/route.ts");
// Listeners
const voucher_on_hub_action_1 = __webpack_require__("./apps/service-voucher/src/listeners/voucher-on-hub-action.ts");
const voucher_on_hotel_action_1 = __webpack_require__("./apps/service-voucher/src/listeners/voucher-on-hotel-action.ts");
const voucher_on_category_action_1 = __webpack_require__("./apps/service-voucher/src/listeners/voucher-on-category-action.ts");
const voucher_on_menu_assign_action_1 = __webpack_require__("./apps/service-voucher/src/listeners/voucher-on-menu-assign-action.ts");
const entities_1 = __webpack_require__("./apps/service-voucher/src/entities.ts");
const app = express();
...
app.use("/api/voucher", route_4.default);
app.use(service_sdk_1.errorHandler);
if (process.env.STAGE === "local") {
    service_sdk_1.expressLocal(app, shared_1.AppEnum.VOUCHER);
    service_sdk_1.eventsLocal({
        ServiceNetworkHubTopic: [voucher_on_hub_action_1.default],
        ServiceNetworkHotelTopic: [voucher_on_hotel_action_1.default],
        ServiceMenuCategoryTopic: [voucher_on_category_action_1.default],
        ServiceMenuMenuTopic: [voucher_on_menu_assign_action_1.default]
    });
}
module.exports.handler = serverless(app);
module.exports.up = service_sdk_1.up;
module.exports.down = service_sdk_1.down;
module.exports.voucherHubOnNetworkHubAction = shared_1.lambdaWarmupWrapper(voucher_on_hub_action_1.default);
module.exports.voucherHotelOnNetworkHotelAction = shared_1.lambdaWarmupWrapper(voucher_on_hotel_action_1.default);
module.exports.voucherCategoryOnMenuCategoryAction = shared_1.lambdaWarmupWrapper(voucher_on_category_action_1.default);
module.exports.voucherHotelOnMenuAssignAction = shared_1.lambdaWarmupWrapper(voucher_on_menu_assign_action_1.default);


/***/ }),

/***/ "./apps/service-voucher/src/program/entities/program.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const hotel_1 = __webpack_require__("./apps/service-voucher/src/hotel/entities/hotel.ts");
const rule_1 = __webpack_require__("./apps/service-voucher/src/rule/entities/rule.ts");
const repository_1 = __webpack_require__("./apps/service-voucher/src/program/repository.ts");
var ProgramStatus;
(function (ProgramStatus) {
    ProgramStatus["ACTIVE"] = "ACTIVE";
    ProgramStatus["INACTIVE"] = "INACTIVE";
})(ProgramStatus = exports.ProgramStatus || (exports.ProgramStatus = {}));
let Program = class Program extends service_sdk_1.BaseEntity {
    constructor() {
        super(...arguments);
        this.hotels = new core_1.Collection(this);
        this.rules = new core_1.Collection(this);
...
tslib_1.__decorate([
    core_1.Enum(() => shared_1.VoucherType),
    tslib_1.__metadata("design:type", typeof (_a = typeof shared_1.VoucherType !== "undefined" && shared_1.VoucherType) === "function" ? _a : Object)
], Program.prototype, "type", void 0);
tslib_1.__decorate([
    core_1.Enum(() => ProgramStatus),
    tslib_1.__metadata("design:type", String)
], Program.prototype, "status", void 0);
tslib_1.__decorate([
    core_1.Property({ length: 255 }),
    tslib_1.__metadata("design:type", typeof (_b = typeof shared_1.VoucherPayer !== "undefined" && shared_1.VoucherPayer) === "function" ? _b : Object)
], Program.prototype, "payer", void 0);
tslib_1.__decorate([
    core_1.Property(),
    tslib_1.__metadata("design:type", Number)
], Program.prototype, "payer_percentage", void 0);
tslib_1.__decorate([
    core_1.Property(),
    tslib_1.__metadata("design:type", Number)
], Program.prototype, "amount", void 0);
tslib_1.__decorate([
    core_1.Enum(() => shared_1.AmountType),
    tslib_1.__metadata("design:type", typeof (_c = typeof shared_1.AmountType !== "undefined" && shared_1.AmountType) === "function" ? _c : Object)
], Program.prototype, "amount_type", void 0);
tslib_1.__decorate([
    core_1.Property({ nullable: true }),
    tslib_1.__metadata("design:type", Number)
], Program.prototype, "code_limit", void 0);
tslib_1.__decorate([
    core_1.Property({ nullable: true }),
    core_1.Unique(),
    tslib_1.__metadata("design:type", Number)
], Program.prototype, "oms_id", void 0);
tslib_1.__decorate([
    core_1.ManyToMany({
        entity: () => hotel_1.default,
        pivotTable: "program_hotel",
    ...
    tslib_1.__metadata("design:type", typeof (_d = typeof core_1.Collection !== "undefined" && core_1.Collection) === "function" ? _d : Object)
], Program.prototype, "hotels", void 0);
tslib_1.__decorate([
    core_1.OneToMany({ entity: () => rule_1.default, mappedBy: "program", orphanRemoval: true }),
    tslib_1.__metadata("design:type", Object)
], Program.prototype, "rules", void 0);
Program = tslib_1.__decorate([
    core_1.Filter({
        name: "programs",
        cond: (args) => ({
            $and: [
                Object.assign({}, (args.status && { status: { $in: args.status } })),
                Object.assign({}, (args.name && { name: { $ilike: args.name } })),
                Object.assign({}, (args.type && { type: { $in: args.type } }))
            ]
        })
    }),
    core_1.Entity({ tableName: "program", customRepository: () => repository_1.ProgramRepository })
], Program);
...
/***/ "./apps/service-voucher/src/program/repository.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
class ProgramRepository extends service_sdk_1.CustomEntityRepository {
}
...
/***/ "./apps/service-voucher/src/program/route.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const express = __webpack_require__("express");
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
const usecases_1 = __webpack_require__("./apps/service-voucher/src/program/usecases/index.ts");
const create_program_1 = __webpack_require__("./apps/service-voucher/src/program/usecases/create-program.ts");
const update_program_1 = __webpack_require__("./apps/service-voucher/src/program/usecases/update-program.ts");
const program_1 = __webpack_require__("./apps/service-voucher/src/program/entities/program.ts");
const batch_edit_status_1 = __webpack_require__("./apps/service-voucher/src/program/usecases/batch-edit-status.ts");
const shared_1 = __webpack_require__("./libs/shared/index.ts");
const router = express.Router();
router.get("/api/voucher/programs/:id", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield usecases_1.default({
            conn: req.conn,
            validate: false,
...
router.get("/api/voucher/programs/hotel/:id", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        let types;
        let statuses;
        if (Array.isArray(req.query.types) && req.query.types.length) {
        ...
        const filters = Object.assign({ programTypes: types && types.map((type) => shared_1.VoucherType[type]), programName: req.query.name, statuses: statuses && statuses.map((status) => program_1.ProgramStatus[status]), populate: req.query.populate && [req.query.populate] }, service_sdk_1.parsePaginationParam(req.query));
        const [data, count] = yield usecases_1.default({ conn: req.conn, validate: false, tenant: req.tenant }).getMultipleByHotel(filters, Number(req.params.id));
        return res.send(service_sdk_1.httpResponse({
            payload: data,
            total: count || 0,
            nextPage: req.query.page ? Number(req.query.page) + 1 : 1
...
router.post("/api/voucher/programs", service_sdk_1.validateRequest(create_program_1.CreateProgramInput), (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield usecases_1.default({
            conn: req.conn,
            validate: false,
...
router.post("/api/voucher/programs/batch-edit-status", service_sdk_1.validateRequest(batch_edit_status_1.EditStatusInput), (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield usecases_1.default({ conn: req.conn, validate: false, tenant: req.tenant }).batchEditStatus(req.body);
        return res.send(service_sdk_1.httpResponse({
            payload: data
        }));
    }
...
router.put("/api/voucher/programs/:id", service_sdk_1.validateRequest(update_program_1.UpdateProgramInput), (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield usecases_1.default({
            conn: req.conn,
            validate: false,
...
router.delete("/api/voucher/programs/:id", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield usecases_1.default({
            conn: req.conn,
            validate: false,
...
/***/ "./apps/service-voucher/src/program/usecases/batch-edit-status.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.EditStatusInput = void 0;
const tslib_1 = __webpack_require__("tslib");
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
const shared_1 = __webpack_require__("./libs/shared/index.ts");
const class_validator_1 = __webpack_require__("class-validator");
const program_1 = __webpack_require__("./apps/service-voucher/src/program/entities/program.ts");
class EditStatusInput {
}
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Array)
], EditStatusInput.prototype, "ids", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsNotEmpty(),
    tslib_1.__metadata("design:type", Boolean)
], EditStatusInput.prototype, "activate", void 0);
exports.EditStatusInput = EditStatusInput;
exports["default"] = (dependency) => {
    ...
    return (data) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        programs.forEach((program) => {
            program.status = data.activate ? program_1.ProgramStatus.ACTIVE : program_1.ProgramStatus.INACTIVE;
            eventData.push(Object.assign({ entity: shared_1.ENTITY.VOUCHER.PROGRAM }, program));
        });
        yield programRepository.flush();
        yield service_sdk_1.eventProvider.client().publish(shared_1.SNS_TOPIC.VOUCHER.PROGRAM, shared_1.PROGRAM_EVENT.STATUS_CHANGED, null, eventData);
        return programs;
    });
};
...
/***/ "./apps/service-voucher/src/program/usecases/create-program.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


var _a, _b, _c;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CreateProgramInput = exports.CreateRuleInput = void 0;
const tslib_1 = __webpack_require__("tslib");
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
const shared_1 = __webpack_require__("./libs/shared/index.ts");
const class_validator_1 = __webpack_require__("class-validator");
...
const core_1 = __webpack_require__("@mikro-orm/core");
const program_1 = __webpack_require__("./apps/service-voucher/src/program/entities/program.ts");
const validator_1 = __webpack_require__("./apps/service-voucher/src/utils/validator.ts");
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Number)
], CreateRuleInput.prototype, "quantity", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsNotEmpty(),
    class_validator_1.IsPositive(),
    tslib_1.__metadata("design:type", Number)
], CreateRuleInput.prototype, "max_price", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Number)
], CreateRuleInput.prototype, "oms_id", void 0);
tslib_1.__decorate([
    class_validator_1.IsArray(),
    class_validator_1.ArrayNotEmpty(),
    tslib_1.__metadata("design:type", Array)
], CreateRuleInput.prototype, "categories", void 0);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", String)
], CreateProgramInput.prototype, "name", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    class_validator_1.MaxLength(500),
    tslib_1.__metadata("design:type", String)
], CreateProgramInput.prototype, "description", void 0);
tslib_1.__decorate([
    class_validator_1.IsEnum(shared_1.VoucherType),
    class_validator_1.IsNotEmpty(),
    tslib_1.__metadata("design:type", typeof (_a = typeof shared_1.VoucherType !== "undefined" && shared_1.VoucherType) === "function" ? _a : Object)
], CreateProgramInput.prototype, "type", void 0);
tslib_1.__decorate([
    class_validator_1.IsEnum(program_1.ProgramStatus),
    class_validator_1.IsNotEmpty(),
    tslib_1.__metadata("design:type", typeof (_b = typeof program_1.ProgramStatus !== "undefined" && program_1.ProgramStatus) === "function" ? _b : Object)
], CreateProgramInput.prototype, "status", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsNotEmpty(),
    class_validator_1.MaxLength(255),
    tslib_1.__metadata("design:type", String)
], CreateProgramInput.prototype, "payer", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsNotEmpty(),
    ...
    tslib_1.__metadata("design:type", Number)
], CreateProgramInput.prototype, "payer_percentage", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsNotEmpty(),
    class_validator_1.IsPositive(),
    tslib_1.__metadata("design:type", Number)
], CreateProgramInput.prototype, "amount", void 0);
tslib_1.__decorate([
    class_validator_1.IsEnum(shared_1.AmountType),
    class_validator_1.IsNotEmpty(),
    tslib_1.__metadata("design:type", typeof (_c = typeof shared_1.AmountType !== "undefined" && shared_1.AmountType) === "function" ? _c : Object)
], CreateProgramInput.prototype, "amount_type", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsNotEmpty(),
    class_validator_1.IsPositive(),
    ...
    tslib_1.__metadata("design:type", Number)
], CreateProgramInput.prototype, "code_limit", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsNotEmpty(),
    tslib_1.__metadata("design:type", Number)
], CreateProgramInput.prototype, "hotel_id", void 0);
tslib_1.__decorate([
    class_validator_1.IsArray(),
    class_validator_1.ArrayNotEmpty(),
    class_validator_1.ValidateNested({ each: true }),
    class_transformer_1.Type(() => CreateRuleInput),
    class_validator_1.ValidateIf((data) => data.type === shared_1.VoucherType.PRE_FIXE),
    tslib_1.__metadata("design:type", Array)
], CreateProgramInput.prototype, "rules", void 0);
exports.CreateProgramInput = CreateProgramInput;
exports["default"] = (dependency) => {
    const { hotelRepository, programRepository, categoryRepository } = dependency;
    return (data) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const hotel = yield hotelRepository.getOneEntityOrFail(data.hotel_id);
        const { rules } = data, programInput = tslib_1.__rest(data, ["rules"]);
        const program = programRepository.create(Object.assign(Object.assign({}, data), { amount_type: validator_1.validateAmountType(programInput.type, programInput.amount_type) }));
        hotel.programs.add(program);
        core_1.wrap(hotel).assign({ updated_at: new Date(Date.now()) });
        if (programInput.type === shared_1.VoucherType.PRE_FIXE) {
            yield validator_1.validateCategories(categoryRepository)(rules);
            core_1.wrap(program).assign(Object.assign({}, rules));
        }
        yield programRepository.persistAndFlush(program);
        yield hotelRepository.persistAndFlush(hotel);
        yield programRepository.populate(program, ["hotels", "rules.categories"]);
        yield service_sdk_1.eventProvider.client().publish(shared_1.SNS_TOPIC.VOUCHER.PROGRAM, shared_1.PROGRAM_EVENT.CREATED, null, Object.assign({ entity: shared_1.ENTITY.VOUCHER.PROGRAM }, program));
        return program;
    });
};
...
/***/ "./apps/service-voucher/src/program/usecases/delete-program.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = (dependency) => {
    const { programRepository } = dependency;
    return (id) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const program = yield programRepository.getOneEntityOrFail(id);
        yield programRepository.softDelete(program.id);
        yield service_sdk_1.eventProvider.client().publish(shared_1.SNS_TOPIC.VOUCHER.PROGRAM, shared_1.PROGRAM_EVENT.DELETED, null, Object.assign({ entity: shared_1.ENTITY.VOUCHER.PROGRAM }, program));
        return program;
    });
};
...
/***/ "./apps/service-voucher/src/program/usecases/get-program.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = (dependency) => {
    const { programRepository } = dependency;
    return (id) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const program = yield programRepository.getOneEntityOrFail(id, ["hotels", "rules.categories.parent_category"]);
        return program;
    });
};
...
/***/ "./apps/service-voucher/src/program/usecases/get-programs-by-hotel.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = (dependency) => {
    ...
    return (filters, hotelId) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        var _a;
        let options = {};
        const programName = (_a = filters === null || filters === void 0 ? void 0 : filters.programName) === null || _a === void 0 ? void 0 : _a.trim();
        if (filters.statuses || filters.programTypes || filters.programName) {
            options = {
                programs: Object.assign(Object.assign(Object.assign({}, (filters.statuses && { status: filters.statuses })), (filters.programTypes && { type: filters.programTypes })), (programName && { name: `%${programName}%` }))
            };
        }
...
/***/ "./apps/service-voucher/src/program/usecases/index.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
const create_program_1 = __webpack_require__("./apps/service-voucher/src/program/usecases/create-program.ts");
const get_program_1 = __webpack_require__("./apps/service-voucher/src/program/usecases/get-program.ts");
const update_program_1 = __webpack_require__("./apps/service-voucher/src/program/usecases/update-program.ts");
const get_programs_by_hotel_1 = __webpack_require__("./apps/service-voucher/src/program/usecases/get-programs-by-hotel.ts");
const delete_program_1 = __webpack_require__("./apps/service-voucher/src/program/usecases/delete-program.ts");
const batch_edit_status_1 = __webpack_require__("./apps/service-voucher/src/program/usecases/batch-edit-status.ts");
const program_1 = __webpack_require__("./apps/service-voucher/src/program/entities/program.ts");
const hotel_1 = __webpack_require__("./apps/service-voucher/src/hotel/entities/hotel.ts");
const rule_1 = __webpack_require__("./apps/service-voucher/src/rule/entities/rule.ts");
...
exports["default"] = (dependency) => {
    const { conn } = dependency;
    return {
        getSingle: get_program_1.default({
            programRepository: conn.em.getRepository(program_1.default)
        }),
        create: create_program_1.default({
            hotelRepository: conn.em.getRepository(hotel_1.default),
            programRepository: conn.em.getRepository(program_1.default),
            categoryRepository: conn.em.getRepository(category_1.default)
        }),
        update: update_program_1.default({
            programRepository: conn.em.getRepository(program_1.default),
            ruleRepository: conn.em.getRepository(rule_1.default),
            categoryRepository: conn.em.getRepository(category_1.default)
        }),
        deleteProgram: delete_program_1.default({
            programRepository: conn.em.getRepository(program_1.default)
        }),
        getMultipleByHotel: get_programs_by_hotel_1.default({
            programRepository: conn.em.getRepository(program_1.default)
        }),
        batchEditStatus: batch_edit_status_1.default({
            programRepository: conn.em.getRepository(program_1.default)
        })
    };
};
...
/***/ "./apps/service-voucher/src/program/usecases/update-program.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


var _a, _b, _c;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.UpdateProgramInput = exports.UpdateRuleInput = void 0;
const tslib_1 = __webpack_require__("tslib");
const core_1 = __webpack_require__("@mikro-orm/core");
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
const shared_1 = __webpack_require__("./libs/shared/index.ts");
...
const program_1 = __webpack_require__("./apps/service-voucher/src/program/entities/program.ts");
const validator_1 = __webpack_require__("./apps/service-voucher/src/utils/validator.ts");
const utils_1 = __webpack_require__("./apps/service-voucher/src/utils/utils.ts");
...
tslib_1.__decorate([
    ...
    class_validator_1.IsPositive(),
    tslib_1.__metadata("design:type", Number)
], UpdateRuleInput.prototype, "id", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsNotEmpty(),
    class_validator_1.IsPositive(),
    tslib_1.__metadata("design:type", Number)
], UpdateRuleInput.prototype, "quantity", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsNotEmpty(),
    class_validator_1.IsPositive(),
    tslib_1.__metadata("design:type", Number)
], UpdateRuleInput.prototype, "max_price", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Number)
], UpdateRuleInput.prototype, "oms_id", void 0);
tslib_1.__decorate([
    class_validator_1.IsArray(),
    class_validator_1.ArrayNotEmpty(),
    tslib_1.__metadata("design:type", Array)
], UpdateRuleInput.prototype, "categories", void 0);
...
tslib_1.__decorate([
    ...
    class_validator_1.MaxLength(255),
    tslib_1.__metadata("design:type", String)
], UpdateProgramInput.prototype, "name", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    class_validator_1.MaxLength(500),
    tslib_1.__metadata("design:type", String)
], UpdateProgramInput.prototype, "description", void 0);
tslib_1.__decorate([
    class_validator_1.IsEnum(shared_1.VoucherType),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", typeof (_a = typeof shared_1.VoucherType !== "undefined" && shared_1.VoucherType) === "function" ? _a : Object)
], UpdateProgramInput.prototype, "type", void 0);
tslib_1.__decorate([
    class_validator_1.IsEnum(program_1.ProgramStatus),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", typeof (_b = typeof program_1.ProgramStatus !== "undefined" && program_1.ProgramStatus) === "function" ? _b : Object)
], UpdateProgramInput.prototype, "status", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    class_validator_1.MaxLength(255),
    tslib_1.__metadata("design:type", String)
], UpdateProgramInput.prototype, "payer", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsOptional(),
    class_validator_1.Min(0),
    class_validator_1.Max(100),
    tslib_1.__metadata("design:type", Number)
], UpdateProgramInput.prototype, "payer_percentage", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsOptional(),
    class_validator_1.IsPositive(),
    tslib_1.__metadata("design:type", Number)
], UpdateProgramInput.prototype, "amount", void 0);
tslib_1.__decorate([
    class_validator_1.IsEnum(shared_1.AmountType),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", typeof (_c = typeof shared_1.AmountType !== "undefined" && shared_1.AmountType) === "function" ? _c : Object)
], UpdateProgramInput.prototype, "amount_type", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsOptional(),
    class_validator_1.IsPositive(),
    class_validator_1.Max(1000),
    tslib_1.__metadata("design:type", Number)
], UpdateProgramInput.prototype, "code_limit", void 0);
tslib_1.__decorate([
    class_validator_1.IsArray(),
    class_validator_1.IsOptional(),
    class_validator_1.ValidateNested({ each: true }),
    class_transformer_1.Type(() => UpdateRuleInput),
    class_validator_1.ValidateIf((data) => data.type === shared_1.VoucherType.PRE_FIXE),
    tslib_1.__metadata("design:type", Array)
], UpdateProgramInput.prototype, "rules", void 0);
exports.UpdateProgramInput = UpdateProgramInput;
exports["default"] = (dependency) => {
    const { programRepository, ruleRepository, categoryRepository } = dependency;
    return (programId, data) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const program = yield programRepository.getOneEntityOrFail({ id: programId }, ["rules.categories"]);
        if (data.type && program.type !== data.type) {
            throw new service_sdk_1.BadRequestError("You can not update program type!");
        }
        const { rules } = data, programInput = tslib_1.__rest(data, ["rules"]);
        if (program.type === shared_1.VoucherType.PRE_FIXE) {
            yield validator_1.validateCategories(categoryRepository)(data.rules);
            const rulesToUpdate = rules.filter((rule) => rule.id);
            const updatedIds = yield utils_1.updateRules(ruleRepository)(rulesToUpdate);
            const rulesToDelete = program.rules.toArray().filter((rule) => {
                return !updatedIds.includes(rule.id);
            });
            if (rulesToDelete.length) {
                yield utils_1.deleteRules(ruleRepository)(rulesToDelete);
            }
            const rulesToCreate = rules.filter((rule) => !rule.id);
            core_1.wrap(program).assign({ rules: [...program.rules, ...rulesToCreate] });
        }
        core_1.wrap(program).assign(Object.assign(Object.assign({}, programInput), { amount_type: validator_1.validateAmountType(program.type, data.amount_type) }));
        yield programRepository.flush();
        yield service_sdk_1.eventProvider.client().publish(shared_1.SNS_TOPIC.VOUCHER.PROGRAM, shared_1.PROGRAM_EVENT.UPDATED, null, Object.assign({ entity: shared_1.ENTITY.VOUCHER.PROGRAM }, program));
        yield program.rules.init();
...
/***/ "./apps/service-voucher/src/rule/entities/rule.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const category_1 = __webpack_require__("./apps/service-voucher/src/category/entities/category.ts");
const program_1 = __webpack_require__("./apps/service-voucher/src/program/entities/program.ts");
const repository_1 = __webpack_require__("./apps/service-voucher/src/rule/repository.ts");
let Rule = class Rule extends service_sdk_1.BaseEntity {
    constructor() {
        super(...arguments);
...
tslib_1.__decorate([
    core_1.Property({ default: 1 }),
    tslib_1.__metadata("design:type", Number)
], Rule.prototype, "quantity", void 0);
tslib_1.__decorate([
    core_1.Property({ nullable: true, type: service_sdk_1.NumericType }),
    tslib_1.__metadata("design:type", Number)
], Rule.prototype, "max_price", void 0);
tslib_1.__decorate([
    core_1.ManyToOne({ entity: () => program_1.default }),
    tslib_1.__metadata("design:type", typeof (_a = typeof program_1.default !== "undefined" && program_1.default) === "function" ? _a : Object)
], Rule.prototype, "program", void 0);
tslib_1.__decorate([
    core_1.Property({ nullable: true }),
    core_1.Unique(),
    tslib_1.__metadata("design:type", Number)
], Rule.prototype, "oms_id", void 0);
tslib_1.__decorate([
    core_1.ManyToMany({ entity: () => category_1.default, mappedBy: "rules", owner: true, pivotTable: "rule_category" }),
    tslib_1.__metadata("design:type", typeof (_b = typeof core_1.Collection !== "undefined" && core_1.Collection) === "function" ? _b : Object)
], Rule.prototype, "categories", void 0);
Rule = tslib_1.__decorate([
    core_1.Entity({ tableName: "rule", customRepository: () => repository_1.RuleRepository })
], Rule);
...
/***/ "./apps/service-voucher/src/rule/repository.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
class RuleRepository extends service_sdk_1.CustomEntityRepository {
}
...
/***/ "./apps/service-voucher/src/utils/utils.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.deleteRules = exports.updateRules = void 0;
const tslib_1 = __webpack_require__("tslib");
const core_1 = __webpack_require__("@mikro-orm/core");
const updateRules = (ruleRepository) => {
    return (rulesToUpdate) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const ruleIds = rulesToUpdate.map((rule) => rule.id);
        const rules = yield ruleRepository.find({ id: ruleIds });
        for (let i = 0; i < rules.length; i += 1) {
            const updatedRule = rulesToUpdate.find((rule) => rules[i].id === rule.id);
            core_1.wrap(rules[i]).assign(Object.assign({}, updatedRule));
        }
        return ruleIds;
    });
};
exports.updateRules = updateRules;
const deleteRules = (ruleRepository) => {
    return (rulesToDelete) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const ruleIds = rulesToDelete.map((rule) => rule.id);
        yield ruleRepository.softDelete(ruleIds);
        return ruleIds;
    });
};
...
/***/ "./apps/service-voucher/src/utils/validator.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.validateCategories = exports.validateAmountType = void 0;
const tslib_1 = __webpack_require__("tslib");
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
const shared_1 = __webpack_require__("./libs/shared/index.ts");
const validateAmountType = (programType, amountType) => {
    return programType !== shared_1.VoucherType.DISCOUNT ? shared_1.AmountType.FIXED : amountType;
};
exports.validateAmountType = validateAmountType;
const validateCategories = (categoryRepository) => {
    return (rules, parent_category) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        if (rules === undefined || rules.length === 0) {
            throw new service_sdk_1.BadRequestError("Empty rules received!");
        }
        const categoryIds = new Set();
        rules.forEach((rule) => {
            rule.categories.forEach((categoryId) => {
        ...
        if (categories.length === categoryIds.size) {
            ...
            categories.forEach((c) => {
                if (c.parent_category.id !== parentCategoryId) {
                    throw new service_sdk_1.BadRequestError("Wrong categories provided!");
                }
            });
        }
        else {
            throw new service_sdk_1.NotFoundError("Category", "Subcategories for PRE_FIXE type don't exist");
        }
    });
};
...
/******/ 	var __webpack_exports__ = __webpack_require__("./apps/service-voucher/src/main.ts");
