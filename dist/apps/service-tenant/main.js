...
/***/ "./apps/service-tenant/src/main.ts":
...
const route_1 = __webpack_require__("./apps/service-tenant/src/tenant/route.ts");
const app = express();
...
if (process.env.STAGE === "local") {
    service_sdk_1.expressLocal(app, shared_1.AppEnum.TENANT);
...
/***/ "./apps/service-tenant/src/tenant/route.ts":
...
const express = __webpack_require__("express");
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
const usecases_1 = __webpack_require__("./apps/service-tenant/src/tenant/usecases/index.ts");
const { getTenant } = usecases_1.default();
const router = express.Router();
router.get("/api/tenant/current", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const tenant = yield getTenant(service_sdk_1.getOrigin(req));
        return res.send({
            result: tenant
        });
    }
...
/***/ "./apps/service-tenant/src/tenant/usecases/get-tenant.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const tslib_1 = __webpack_require__("tslib");
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
exports["default"] = (dynamoConnection) => {
...
/***/ "./apps/service-tenant/src/tenant/usecases/index.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
const AWS = __webpack_require__("aws-sdk");
const get_tenant_1 = __webpack_require__("./apps/service-tenant/src/tenant/usecases/get-tenant.ts");
const dynamoConnection = new AWS.DynamoDB.DocumentClient(process.env.STAGE === "local" ? {
    region: "localhost",
    endpoint: "http://0.0.0.0:8000"
} : {});
exports["default"] = () => ({
    getTenant: get_tenant_1.default(dynamoConnection)
});
...
/******/ 	var __webpack_exports__ = __webpack_require__("./apps/service-tenant/src/main.ts");
