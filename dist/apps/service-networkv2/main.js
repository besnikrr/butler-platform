...
/***/ "./apps/service-networkv2/src/city/entity.ts":
...
const base_entity_1 = __webpack_require__("./apps/service-networkv2/src/db/utils/base-entity.ts");
const entity_1 = __webpack_require__("./apps/service-networkv2/src/hub/entity.ts");
let City = class City extends base_entity_1.default {
    constructor(city) {
        super();
        this.hubs = new core_1.Collection(this);
        this.oms_id = city.oms_id;
        this.name = city.name;
        this.time_zone = city.time_zone;
...
City = tslib_1.__decorate([
    core_1.Entity({
        customRepository: () => service_sdk_1.CustomEntityRepository,
    }),
    core_1.Filter({ name: "name", cond: (args) => ({ name: { $eq: args.name } }) }),
    tslib_1.__metadata("design:paramtypes", [City])
], City);
...
/***/ "./apps/service-networkv2/src/city/route.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const usecases_1 = __webpack_require__("./apps/service-networkv2/src/city/usecases/index.ts");
const util_1 = __webpack_require__("./apps/service-networkv2/src/utils/util.ts");
const validations_1 = __webpack_require__("./apps/service-networkv2/src/city/validations/index.ts");
const validate_request_1 = __webpack_require__("./apps/service-networkv2/src/utils/middlewares/validate-request.ts");
const router = express.Router();
router.get("/api/network/cities", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const [data, count] = yield usecases_1.default(req.conn).getCities(Object.assign(Object.assign({}, util_1.parsePaginationParam(req.query)), { name: req.query.name }));
        return res.send(util_1.httpResponse({
            payload: data,
            total: count || 0,
            nextPage: 0,
        }));
...
router.get("/api/network/cities/:id", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield usecases_1.default(req.conn).getCity(Number(req.params.id));
        return res.send(util_1.httpResponse({
            payload: data,
        }));
    }
...
router.post("/api/network/cities/", validate_request_1.default(validations_1.CreateCityRequest), (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield usecases_1.default(req.conn).createCity(req.body);
        return res.send(util_1.httpResponse({
            payload: data,
        }));
    }
...
router.patch("/api/network/cities/:id", validate_request_1.default(validations_1.UpdateCityRequest), (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const cityId = Number(req.params.id);
        const { body } = req;
        const data = yield usecases_1.default(req.conn).updateCity(cityId, body);
        return res.send(util_1.httpResponse({
            payload: data,
        }));
    }
...
router.delete("/api/network/cities/:id", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield usecases_1.default(req.conn).deleteCity(Number(req.params.id));
        return res.send(util_1.httpResponse({
            payload: data,
        }));
    }
...
/***/ "./apps/service-networkv2/src/city/usecases/create-city.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const entity_1 = __webpack_require__("./apps/service-networkv2/src/city/entity.ts");
const TOPIC = "SERVICE_NETWORK_CITY";
const entity = "city";
exports["default"] = (cityRepository) => {
    return (cityInput) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield cityRepository.failIfEntityExists({
            name: cityInput.name,
        });
        const cityToCreate = new entity_1.default(cityInput);
        yield cityRepository.persistAndFlush(cityToCreate);
        const payload = Object.assign({ entity }, cityToCreate);
        service_sdk_1.eventProvider.client().publish(TOPIC, shared_1.CITY_EVENT.CREATED, null, payload);
        return cityToCreate;
    });
};
...
/***/ "./apps/service-networkv2/src/city/usecases/delete-city.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = (cityRepository) => {
    return (id) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const city = yield cityRepository.findOne({ id }, ["hubs"]);
        if (!city) {
            throw new service_sdk_1.NotFoundError("City not found!");
        }
        const length = city.hubs.count();
        if (!length) {
            throw new service_sdk_1.ConflictError("City has hub relations");
        }
        return cityRepository.softDelete({ deleteOne: id });
    });
};
...
/***/ "./apps/service-networkv2/src/city/usecases/get-list-cities.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = (cityRepository) => {
    return (filters) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const whereFilters = Object.assign({ deleted_at: null }, (filters.name &&
            filters.name.trim() && {
            name: {
                $ilike: `%${filters.name}%`,
            },
...
/***/ "./apps/service-networkv2/src/city/usecases/get-single-city.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = (cityRepository) => {
    return (id) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        return cityRepository.findOneOrFail(id);
    });
};
...
/***/ "./apps/service-networkv2/src/city/usecases/index.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
const entity_1 = __webpack_require__("./apps/service-networkv2/src/city/entity.ts");
const get_list_cities_1 = __webpack_require__("./apps/service-networkv2/src/city/usecases/get-list-cities.ts");
const get_single_city_1 = __webpack_require__("./apps/service-networkv2/src/city/usecases/get-single-city.ts");
const create_city_1 = __webpack_require__("./apps/service-networkv2/src/city/usecases/create-city.ts");
const update_city_1 = __webpack_require__("./apps/service-networkv2/src/city/usecases/update-city.ts");
const delete_city_1 = __webpack_require__("./apps/service-networkv2/src/city/usecases/delete-city.ts");
exports["default"] = (conn) => {
    return {
        getCities: get_list_cities_1.default(conn.em.getRepository(entity_1.default)),
        getCity: get_single_city_1.default(conn.em.getRepository(entity_1.default)),
        createCity: create_city_1.default(conn.em.getRepository(entity_1.default)),
        updateCity: update_city_1.default(conn.em.getRepository(entity_1.default)),
        deleteCity: delete_city_1.default(conn.em.getRepository(entity_1.default)),
    };
};
...
/***/ "./apps/service-networkv2/src/city/usecases/update-city.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = (cityRepository) => {
    return (id, cityInput) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        const cityToUpdate = yield cityRepository.findOneOrFail({ id });
        core_1.wrap(cityToUpdate).assign(cityInput);
        yield cityRepository.persistAndFlush(cityToUpdate);
        const payload = Object.assign({ entity }, cityToUpdate);
        service_sdk_1.eventProvider.client().publish(TOPIC, shared_1.CITY_EVENT.UPDATED, null, payload);
        return cityToUpdate;
    });
};
...
/***/ "./apps/service-networkv2/src/city/validations/create-city.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CreateCityRequest = void 0;
const tslib_1 = __webpack_require__("tslib");
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", String)
], CreateCityRequest.prototype, "name", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Number)
], CreateCityRequest.prototype, "oms_id", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsNotEmpty(),
    tslib_1.__metadata("design:type", String)
], CreateCityRequest.prototype, "time_zone", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateCityRequest.prototype, "state", void 0);
exports.CreateCityRequest = CreateCityRequest;


/***/ }),

/***/ "./apps/service-networkv2/src/city/validations/index.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./apps/service-networkv2/src/city/validations/create-city.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./apps/service-networkv2/src/city/validations/update-city.ts"), exports);


/***/ }),

/***/ "./apps/service-networkv2/src/city/validations/update-city.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.UpdateCityRequest = void 0;
const tslib_1 = __webpack_require__("tslib");
/* eslint-disable import/prefer-default-export */
const class_validator_1 = __webpack_require__("class-validator");
...
tslib_1.__decorate([
    ...
    class_validator_1.IsNotEmpty(),
    tslib_1.__metadata("design:type", String)
], UpdateCityRequest.prototype, "name", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Number)
], UpdateCityRequest.prototype, "oms_id", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsNotEmpty(),
    tslib_1.__metadata("design:type", String)
], UpdateCityRequest.prototype, "time_zone", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateCityRequest.prototype, "state", void 0);
exports.UpdateCityRequest = UpdateCityRequest;


/***/ }),

/***/ "./apps/service-networkv2/src/db/utils/base-entity.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "./apps/service-networkv2/src/hotel/entity.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
let Hotel = class Hotel extends service_sdk_1.BaseEntity {
    constructor(hotel) {
        super();
        this.oms_id = hotel.oms_id;
        this.hub_id = hotel.hub_id;
        this.name = hotel.name;
        this.formal_name = hotel.formal_name;
        this.is_tax_exempt = hotel.is_tax_exempt;
        this.active = hotel.active;
        this.address_street = hotel.address_street;
        this.address_number = hotel.address_number;
        this.address_town = hotel.address_town;
        this.address_zip_code = hotel.address_zip_code;
        this.address_coordinates = hotel.address_coordinates;
        this.web_active = hotel.web_active;
        this.web_phone = hotel.web_phone;
        this.web_url_id = hotel.web_url_id;
        this.web_code = hotel.web_code;
        this.contact_person = hotel.contact_person;
        this.contact_email = hotel.contact_email;
        this.account_manager_id = hotel.account_manager_id;
        this.room_count = hotel.room_count;
        this.room_numbers = hotel.room_numbers;
        this.delivery_instructions = hotel.delivery_instructions;
        this.reskin_config = hotel.reskin_config;
        this.allow_payment_room_charge = hotel.allow_payment_room_charge;
        this.allow_payment_credit_card = hotel.allow_payment_credit_card;
        this.allow_scheduled_orders = hotel.allow_scheduled_orders;
        this.last_invoice_number = hotel.last_invoice_number;
        this.has_vouchers_enabled = hotel.has_vouchers_enabled;
        this.has_pms_enabled = hotel.has_pms_enabled;
        this.has_car_service_enabled = hotel.has_car_service_enabled;
        this.has_activities_enabled = hotel.has_activities_enabled;
    }
};
tslib_1.__decorate([
...
tslib_1.__decorate([
    core_1.Property({ length: 50, nullable: true }),
    tslib_1.__metadata("design:type", String)
...
tslib_1.__decorate([
    core_1.Property({ length: 10, nullable: true }),
    tslib_1.__metadata("design:type", String)
...
tslib_1.__decorate([
    core_1.Property({ nullable: true }),
    tslib_1.__metadata("design:type", Number)
], Hotel.prototype, "last_invoice_number", void 0);
tslib_1.__decorate([
    core_1.Property({ nullable: true }),
    tslib_1.__metadata("design:type", Boolean)
...
Hotel = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [Hotel])
], Hotel);
...
/***/ "./apps/service-networkv2/src/hotel/route.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/* eslint-disable consistent-return */
const express = __webpack_require__("express");
const usecases_1 = __webpack_require__("./apps/service-networkv2/src/hotel/usecases/index.ts");
const util_1 = __webpack_require__("./apps/service-networkv2/src/utils/util.ts");
const validate_request_1 = __webpack_require__("./apps/service-networkv2/src/utils/middlewares/validate-request.ts");
const validations_1 = __webpack_require__("./apps/service-networkv2/src/hotel/validations/index.ts");
const router = express.Router();
router.get("/api/network/hotels/", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const [data, count] = yield usecases_1.default(req.conn).listHotels(Object.assign(Object.assign({}, util_1.parsePaginationParam(req.query)), { name: req.query.name, hub_id: req.query.hub_id, active: req.query.active }));
        return res.send(util_1.httpResponse({
            payload: data,
            total: count || 0,
            nextPage: 0,
...
router.get("/api/network/hotels/:id", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield usecases_1.default(req.conn).getHotel(Number(req.params.id));
        return res.send(util_1.httpResponse({
            payload: data,
        }));
    }
...
router.post("/api/network/hotels/", validate_request_1.default(validations_1.CreateHotelRequest), (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield usecases_1.default(req.conn).createHotel(req.body);
        return res.send(util_1.httpResponse({
            payload: data,
        }));
    }
...
router.patch("/api/network/hotels/:id", validate_request_1.default(validations_1.UpdateHotelRequest), (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const { body } = req;
        const { id } = req.params;
        const data = yield usecases_1.default(req.conn).updateHotel(Number(id), body);
        return res.send(util_1.httpResponse({
            payload: data,
        }));
    }
...
router.delete("/api/network/hotels/:id", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield usecases_1.default(req.conn).deleteHotel(Number(req.params.id));
        return res.send(util_1.httpResponse({
            payload: data,
        }));
    }
...
router.patch("/api/network/hotels/status/:id", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const { status } = req.body;
        const data = yield usecases_1.default(req.conn).changeStatusHotel(Number(id), status);
        return res.send(util_1.httpResponse({
            payload: data,
        }));
    }
...
/***/ "./apps/service-networkv2/src/hotel/usecases/change-status-hotel.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
const shared_1 = __webpack_require__("./libs/shared/index.ts");
const TOPIC = "SERVICE_NETWORK_HOTEL";
const entity = "hotel";
exports["default"] = (hotelRepository) => {
    return (id, status) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const hotel = yield hotelRepository.findOne({ id, deleted_at: null });
        if (!hotel) {
            throw new service_sdk_1.NotFoundError("Hotel not found");
        }
        core_1.wrap(hotel).assign({ active: status });
        yield hotelRepository.persistAndFlush(hotel);
        const payload = Object.assign({ entity }, hotel);
        service_sdk_1.eventProvider.client().publish(TOPIC, shared_1.HOTEL_EVENT.UPDATED, null, payload);
        return hotel;
    });
};
...
/***/ "./apps/service-networkv2/src/hotel/usecases/create-hotel.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
const shared_1 = __webpack_require__("./libs/shared/index.ts");
const entity_1 = __webpack_require__("./apps/service-networkv2/src/hotel/entity.ts");
const TOPIC = "SERVICE_NETWORK_HOTEL";
const entity = "hotel";
exports["default"] = (hotelRepository) => {
    return (data) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        const hotelToCreate = new entity_1.default(data);
        yield hotelRepository.persistAndFlush(hotelToCreate);
        const payload = Object.assign(Object.assign({}, hotelToCreate), { entity });
        service_sdk_1.eventProvider.client().publish(TOPIC, shared_1.HOTEL_EVENT.CREATED, null, payload);
        return hotelRepository.populate(hotelToCreate, ["hub"]);
    });
};
...
/***/ "./apps/service-networkv2/src/hotel/usecases/delete-hotel.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = (hotelRepository) => {
    return (id) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        return hotelRepository.softDelete({ deleteOne: id });
    });
};
...
/***/ "./apps/service-networkv2/src/hotel/usecases/get-list-hotels.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = (hotelRepository) => {
    return (filters) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const whereFilters = Object.assign(Object.assign(Object.assign({ deleted_at: null }, (filters.name &&
            filters.name.trim() && {
            $or: [
                {
                    name: {
...
/***/ "./apps/service-networkv2/src/hotel/usecases/get-single-hotel.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = (hotelRepository) => {
    return (id) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        if (!hotel) {
            throw new core_1.NotFoundError("Hotel");
        }
        return hotel;
    });
};
...
/***/ "./apps/service-networkv2/src/hotel/usecases/index.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
const get_list_hotels_1 = __webpack_require__("./apps/service-networkv2/src/hotel/usecases/get-list-hotels.ts");
const create_hotel_1 = __webpack_require__("./apps/service-networkv2/src/hotel/usecases/create-hotel.ts");
const update_hotel_1 = __webpack_require__("./apps/service-networkv2/src/hotel/usecases/update-hotel.ts");
const get_single_hotel_1 = __webpack_require__("./apps/service-networkv2/src/hotel/usecases/get-single-hotel.ts");
const entity_1 = __webpack_require__("./apps/service-networkv2/src/hotel/entity.ts");
const delete_hotel_1 = __webpack_require__("./apps/service-networkv2/src/hotel/usecases/delete-hotel.ts");
const change_status_hotel_1 = __webpack_require__("./apps/service-networkv2/src/hotel/usecases/change-status-hotel.ts");
exports["default"] = (conn) => {
    return {
        listHotels: get_list_hotels_1.default(conn.em.getRepository(entity_1.default)),
        createHotel: create_hotel_1.default(conn.em.getRepository(entity_1.default)),
        updateHotel: update_hotel_1.default(conn.em.getRepository(entity_1.default)),
        getHotel: get_single_hotel_1.default(conn.em.getRepository(entity_1.default)),
        deleteHotel: delete_hotel_1.default(conn.em.getRepository(entity_1.default)),
        changeStatusHotel: change_status_hotel_1.default(conn.em.getRepository(entity_1.default)),
    };
};
...
/***/ "./apps/service-networkv2/src/hotel/usecases/update-hotel.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = (hotelRepository) => {
    return (id, hotelInput) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        const hotelToUpdate = new entity_1.default(hotelInput);
        core_1.wrap(hotel).assign(hotelToUpdate);
        yield hotelRepository.persistAndFlush(hotel);
        const payload = Object.assign({ entity }, hotel);
        service_sdk_1.eventProvider.client().publish(TOPIC, shared_1.HOTEL_EVENT.UPDATED, null, payload);
        return hotel;
...
/***/ "./apps/service-networkv2/src/hotel/validations/create-hotel.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CreateHotelRequest = void 0;
const tslib_1 = __webpack_require__("tslib");
const class_validator_1 = __webpack_require__("class-validator");
...
tslib_1.__decorate([
    ...
    class_validator_1.IsNotEmpty(),
    tslib_1.__metadata("design:type", String)
], CreateHotelRequest.prototype, "name", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsNotEmpty(),
    tslib_1.__metadata("design:type", String)
], CreateHotelRequest.prototype, "hub_id", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Number)
], CreateHotelRequest.prototype, "oms_id", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHotelRequest.prototype, "formal_name", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], CreateHotelRequest.prototype, "is_tax_exempt", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], CreateHotelRequest.prototype, "active", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHotelRequest.prototype, "address_street", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHotelRequest.prototype, "address_number", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHotelRequest.prototype, "address_town", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHotelRequest.prototype, "address_zip_code", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHotelRequest.prototype, "address_coordinates", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], CreateHotelRequest.prototype, "web_active", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHotelRequest.prototype, "web_phone", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHotelRequest.prototype, "web_url_id", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHotelRequest.prototype, "web_code", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHotelRequest.prototype, "contact_person", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHotelRequest.prototype, "contact_email", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Number)
], CreateHotelRequest.prototype, "account_manager_id", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Number)
], CreateHotelRequest.prototype, "room_count", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHotelRequest.prototype, "room_numbers", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHotelRequest.prototype, "delivery_instructions", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHotelRequest.prototype, "reskin_config", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], CreateHotelRequest.prototype, "allow_payment_room_charge", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], CreateHotelRequest.prototype, "allow_payment_credit_card", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], CreateHotelRequest.prototype, "allow_scheduled_orders", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Number)
], CreateHotelRequest.prototype, "last_invoice_number", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], CreateHotelRequest.prototype, "has_vouchers_enabled", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], CreateHotelRequest.prototype, "has_pms_enabled", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], CreateHotelRequest.prototype, "has_car_service_enabled", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], CreateHotelRequest.prototype, "has_activities_enabled", void 0);
exports.CreateHotelRequest = CreateHotelRequest;


/***/ }),

/***/ "./apps/service-networkv2/src/hotel/validations/index.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./apps/service-networkv2/src/hotel/validations/create-hotel.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./apps/service-networkv2/src/hotel/validations/update-hotel.ts"), exports);


/***/ }),

/***/ "./apps/service-networkv2/src/hotel/validations/update-hotel.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.UpdateHotelRequest = void 0;
const tslib_1 = __webpack_require__("tslib");
const class_validator_1 = __webpack_require__("class-validator");
...
tslib_1.__decorate([
    ...
    class_validator_1.IsNotEmpty(),
    tslib_1.__metadata("design:type", String)
], UpdateHotelRequest.prototype, "name", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsNotEmpty(),
    tslib_1.__metadata("design:type", String)
], UpdateHotelRequest.prototype, "hub_id", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Number)
], UpdateHotelRequest.prototype, "oms_id", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHotelRequest.prototype, "formal_name", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], UpdateHotelRequest.prototype, "is_tax_exempt", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], UpdateHotelRequest.prototype, "active", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHotelRequest.prototype, "address_street", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHotelRequest.prototype, "address_number", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHotelRequest.prototype, "address_town", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHotelRequest.prototype, "address_zip_code", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHotelRequest.prototype, "address_coordinates", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], UpdateHotelRequest.prototype, "web_active", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHotelRequest.prototype, "web_phone", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHotelRequest.prototype, "web_url_id", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHotelRequest.prototype, "web_code", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHotelRequest.prototype, "contact_person", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHotelRequest.prototype, "contact_email", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Number)
], UpdateHotelRequest.prototype, "account_manager_id", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Number)
], UpdateHotelRequest.prototype, "room_count", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHotelRequest.prototype, "room_numbers", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHotelRequest.prototype, "delivery_instructions", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHotelRequest.prototype, "reskin_config", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], UpdateHotelRequest.prototype, "allow_payment_room_charge", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], UpdateHotelRequest.prototype, "allow_payment_credit_card", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], UpdateHotelRequest.prototype, "allow_scheduled_orders", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Number)
], UpdateHotelRequest.prototype, "last_invoice_number", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], UpdateHotelRequest.prototype, "has_vouchers_enabled", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], UpdateHotelRequest.prototype, "has_pms_enabled", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], UpdateHotelRequest.prototype, "has_car_service_enabled", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], UpdateHotelRequest.prototype, "has_activities_enabled", void 0);
exports.UpdateHotelRequest = UpdateHotelRequest;


/***/ }),

/***/ "./apps/service-networkv2/src/hub/entity.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
const entity_1 = __webpack_require__("./apps/service-networkv2/src/city/entity.ts");
const entity_2 = __webpack_require__("./apps/service-networkv2/src/hotel/entity.ts");
let Hub = class Hub extends service_sdk_1.BaseEntity {
    constructor(hub) {
        super();
        this.hotels = new core_1.Collection(this);
        this.oms_id = hub.oms_id;
        this.city_id = hub.city_id;
        this.name = hub.name;
        this.active = hub.active;
        this.tax_rate = hub.tax_rate;
        this.contact_phone = hub.contact_phone;
        this.contact_email = hub.contact_email;
        this.address_street = hub.address_street;
        this.address_number = hub.address_number;
        this.address_town = hub.address_town;
        this.address_zip_code = hub.address_zip_code;
        this.address_coordinates = hub.address_coordinates;
        this.has_nextmv_enabled = hub.has_nextmv_enabled;
        this.has_expeditor_app_enabled = hub.has_expeditor_app_enabled;
    }
};
tslib_1.__decorate([
    core_1.Property({ nullable: true }),
...
tslib_1.__decorate([
    core_1.Property(),
    tslib_1.__metadata("design:type", Number)
], Hub.prototype, "city_id", void 0);
tslib_1.__decorate([
    core_1.ManyToOne(),
    tslib_1.__metadata("design:type", typeof (_a = typeof entity_1.default !== "undefined" && entity_1.default) === "function" ? _a : Object)
], Hub.prototype, "city", void 0);
tslib_1.__decorate([
    core_1.Property({ length: 200 }),
    tslib_1.__metadata("design:type", String)
...
Hub = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [Hub])
], Hub);
exports["default"] = Hub;
...
/***/ "./apps/service-networkv2/src/hub/route.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/* eslint-disable consistent-return */
const express = __webpack_require__("express");
const common_1 = __webpack_require__("./apps/service-networkv2/src/utils/common.ts");
const util_1 = __webpack_require__("./apps/service-networkv2/src/utils/util.ts");
const usecases_1 = __webpack_require__("./apps/service-networkv2/src/hub/usecases/index.ts");
const validate_request_1 = __webpack_require__("./apps/service-networkv2/src/utils/middlewares/validate-request.ts");
const validations_1 = __webpack_require__("./apps/service-networkv2/src/hub/validations/index.ts");
const router = express.Router();
router.get("/api/network/hubs", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const [data, count] = yield usecases_1.default(req.conn).listHubs(Object.assign(Object.assign({}, util_1.parsePaginationParam(req.query)), { name: req.query.name, city_id: req.query.city_id, active: req.query.active }));
        return res.send(common_1.httpResponse({
            payload: data,
            total: count || 0,
            nextPage: 0,
        }));
...
router.get("/api/network/hubs/:id", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield usecases_1.default(req.conn).getHub(Number(req.params.id));
        return res.send(common_1.httpResponse({
            payload: data,
        }));
    }
...
router.post("/api/network/hubs", validate_request_1.default(validations_1.CreateHubRequest), (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const { body } = req;
        const data = yield usecases_1.default(req.conn).createHub(body);
        return res.send(common_1.httpResponse({
            payload: data,
        }));
    }
...
router.patch("/api/network/hubs/:id", validate_request_1.default(validations_1.UpdateHubRequest), (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const { body } = req;
        const { id } = req.params;
        const data = yield usecases_1.default(req.conn).updateHub(Number(id), body);
        return res.send(common_1.httpResponse({
            payload: data,
        }));
    }
...
router.delete("/api/network/hubs/:id", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield usecases_1.default(req.conn).deleteHub(Number(req.params.id));
        return res.send(common_1.httpResponse({
            payload: data,
        }));
    }
...
router.patch("/api/network/hubs/status/:id", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const { status } = req.body;
        const data = yield usecases_1.default(req.conn).changeStatusHub(Number(id), status);
        return res.send(common_1.httpResponse({
            payload: data,
        }));
    }
...
router.patch("/api/network/hubs/reassign-hotels/:id", (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const { data } = req.body;
        const { id } = req.params;
        const payload = yield usecases_1.default(req.conn).reassignHubHotels({ data }, Number(id));
        return res.send(common_1.httpResponse({
            payload,
        }));
    }
...
/***/ "./apps/service-networkv2/src/hub/usecases/change-status-hub.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const core_1 = __webpack_require__("@mikro-orm/core");
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
exports["default"] = (hubRepository) => {
    return (id, status) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const hubToUpdate = yield hubRepository.findOne({ id, deleted_at: null }, { populate: ["hotels"] });
        if (!hubToUpdate) {
            throw new core_1.NotFoundError("Hub not found!");
        }
        const { length } = hubToUpdate.hotels.count;
        if (!status && length) {
            throw new service_sdk_1.ConflictError("This hub have hotels that need to assign to another hub.");
        }
        core_1.wrap(hubToUpdate).assign({ active: status });
        yield hubRepository.persistAndFlush(hubToUpdate);
        return hubToUpdate;
    });
};
...
/***/ "./apps/service-networkv2/src/hub/usecases/create-hub.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const shared_1 = __webpack_require__("./libs/shared/index.ts");
const entity_1 = __webpack_require__("./apps/service-networkv2/src/hub/entity.ts");
const TOPIC = "SERVICE_NETWORK_HUB";
const entity = "hub";
exports["default"] = (hubRepository, cityRepository) => {
    return (data) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield hubRepository.failIfEntityExists({
            name: data.name,
        });
        const city = yield cityRepository.findOne({ id: data.city_id });
        if (!city) {
            throw new service_sdk_1.ConflictError("City does not exists!");
        }
        const hubToCreate = new entity_1.default(data);
        yield hubRepository.persistAndFlush(hubToCreate);
        const payload = Object.assign({ entity }, hubToCreate);
        service_sdk_1.eventProvider.client().publish(TOPIC, shared_1.HUB_EVENT.CREATED, null, payload);
        return hubRepository.populate(hubToCreate, ["city"]);
    });
};
...
/***/ "./apps/service-networkv2/src/hub/usecases/delete-hub.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = (hubRepository) => {
    return (id) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const hub = yield hubRepository.findOne({ id }, ["hotels"]);
        if (!hub) {
        ...
        return hubRepository.softDelete({ deleteOne: id });
    });
};
...
/***/ "./apps/service-networkv2/src/hub/usecases/get-list-hubs.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "./apps/service-networkv2/src/hub/usecases/get-single-hub.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = (hubRepository) => {
    return (id) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const hub = yield hubRepository.findOne({ id, deleted_at: null }, {
            populate: ["city", "hotels"],
        });
        if (!hub) {
            throw new service_sdk_1.NotFoundError("Hub");
        }
        return hub;
    });
};
...
/***/ "./apps/service-networkv2/src/hub/usecases/index.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
const get_list_hubs_1 = __webpack_require__("./apps/service-networkv2/src/hub/usecases/get-list-hubs.ts");
const create_hub_1 = __webpack_require__("./apps/service-networkv2/src/hub/usecases/create-hub.ts");
const update_hub_1 = __webpack_require__("./apps/service-networkv2/src/hub/usecases/update-hub.ts");
const get_single_hub_1 = __webpack_require__("./apps/service-networkv2/src/hub/usecases/get-single-hub.ts");
const entity_1 = __webpack_require__("./apps/service-networkv2/src/hub/entity.ts");
const entity_2 = __webpack_require__("./apps/service-networkv2/src/city/entity.ts");
const delete_hub_1 = __webpack_require__("./apps/service-networkv2/src/hub/usecases/delete-hub.ts");
const change_status_hub_1 = __webpack_require__("./apps/service-networkv2/src/hub/usecases/change-status-hub.ts");
const reassign_hotels_hub_1 = __webpack_require__("./apps/service-networkv2/src/hub/usecases/reassign-hotels-hub.ts");
const entity_3 = __webpack_require__("./apps/service-networkv2/src/hotel/entity.ts");
exports["default"] = (conn) => {
    return {
        listHubs: get_list_hubs_1.default(conn.em.getRepository(entity_1.default)),
        createHub: create_hub_1.default(conn.em.getRepository(entity_1.default), conn.em.getRepository(entity_2.default)),
        updateHub: update_hub_1.default(conn.em.getRepository(entity_1.default)),
        getHub: get_single_hub_1.default(conn.em.getRepository(entity_1.default)),
        deleteHub: delete_hub_1.default(conn.em.getRepository(entity_1.default)),
        changeStatusHub: change_status_hub_1.default(conn.em.getRepository(entity_1.default)),
        reassignHubHotels: reassign_hotels_hub_1.default(conn.em.getRepository(entity_1.default), conn.em.getRepository(entity_3.default)),
    };
};
...
/***/ "./apps/service-networkv2/src/hub/usecases/reassign-hotels-hub.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const service_sdk_1 = __webpack_require__("./libs/service-sdk/index.ts");
const shared_1 = __webpack_require__("./libs/shared/index.ts");
const HOTEL_TOPIC = "SERVICE_NETWORK_HOTEL";
const HUB_TOPIC = "SERVICE_NETWORK_HUB";
const hubEntity = "hub";
const hotelEntity = "hotel";
exports["default"] = (hubRepository, hotelRepository) => {
    function validateHotelIds(hotels, hotelHubs) {
        // eslint-disable-next-line consistent-return
        hotels.getItems().forEach((hotel) => {
            if (!hotelHubs.data.find((element) => element.hotelId === hotel.id)) {
                return false;
            }
        });
        return true;
    ...
    return (hotelHubs, hubIdToDeactivate) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const hubToDeactivate = yield hubRepository.findOne({ id: hubIdToDeactivate, deleted_at: null }, { populate: ["hotels"] });
        const length = hubToDeactivate.hotels.count();
        // const { length } = hubToDeactivate.hotels.count;
        if (length !== hotelHubs.data.length) {
            throw new service_sdk_1.ConflictError("Please make sure to reassign all hotels!");
        }
        if (!length || !validateHotelIds(hubToDeactivate.hotels, hotelHubs)) {
            throw new service_sdk_1.NotFoundError("Hotel ids are not relevant!");
        }
        const hubs = yield hubRepository.find({ id: { $in: hotelHubs.data.map((el) => el.hubId) }, deleted_at: null });
        const hotels = yield hotelRepository.find({ id: { $in: hotelHubs.data.map((el) => el.hotelId) }, deleted_at: null });
        // eslint-disable-next-line no-restricted-syntax
        for (const data of hotelHubs.data) {
            ...
            core_1.wrap(hotel).assign({ hub_id: data.hubId });
            // eslint-disable-next-line no-await-in-loop
            yield hotelRepository.persistAndFlush(hotel);
            const hotelPayload = Object.assign({ hotelEntity }, hotel);
            service_sdk_1.eventProvider.client().publish(HOTEL_TOPIC, shared_1.HOTEL_EVENT.UPDATED, null, hotelPayload);
        }
        if (!hubToDeactivate) {
            throw new service_sdk_1.NotFoundError("Hub not found");
        }
        core_1.wrap(hubToDeactivate).assign({ active: false });
        yield hubRepository.persistAndFlush(hubToDeactivate);
        const hubPayload = Object.assign({ hubEntity }, hubToDeactivate);
        service_sdk_1.eventProvider.client().publish(HUB_TOPIC, shared_1.HOTEL_EVENT.UPDATED, null, hubPayload);
        return hubRepository.findOne({ id: hubIdToDeactivate, deleted_at: null });
    });
};
...
/***/ "./apps/service-networkv2/src/hub/usecases/update-hub.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = (hubRepository) => {
    return (id, hubInput) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        const hubToUpdate = new entity_1.default(hubInput);
        core_1.wrap(hub).assign(hubToUpdate);
        yield hubRepository.persistAndFlush(hub);
        const payload = Object.assign({ entity }, hub);
        service_sdk_1.eventProvider.client().publish(TOPIC, shared_1.HUB_EVENT.UPDATED, null, payload);
        return hub;
    });
};
...
/***/ "./apps/service-networkv2/src/hub/validations/create-hub.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CreateHubRequest = void 0;
const tslib_1 = __webpack_require__("tslib");
const class_validator_1 = __webpack_require__("class-validator");
...
tslib_1.__decorate([
    ...
    class_validator_1.IsNotEmpty(),
    tslib_1.__metadata("design:type", String)
], CreateHubRequest.prototype, "name", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsNotEmpty(),
    tslib_1.__metadata("design:type", String)
], CreateHubRequest.prototype, "city_id", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Number)
], CreateHubRequest.prototype, "oms_id", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Number)
], CreateHubRequest.prototype, "tax_rate", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHubRequest.prototype, "contact_phone", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHubRequest.prototype, "contact_email", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHubRequest.prototype, "address_street", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHubRequest.prototype, "address_number", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHubRequest.prototype, "address_town", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHubRequest.prototype, "address_zip_code", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], CreateHubRequest.prototype, "address_coordinates", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], CreateHubRequest.prototype, "has_nextmv_enabled", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], CreateHubRequest.prototype, "has_expeditor_app_enabled", void 0);
exports.CreateHubRequest = CreateHubRequest;


/***/ }),

/***/ "./apps/service-networkv2/src/hub/validations/index.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./apps/service-networkv2/src/hub/validations/create-hub.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./apps/service-networkv2/src/hub/validations/update-hub.ts"), exports);


/***/ }),

/***/ "./apps/service-networkv2/src/hub/validations/update-hub.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.UpdateHubRequest = void 0;
const tslib_1 = __webpack_require__("tslib");
const class_validator_1 = __webpack_require__("class-validator");
...
tslib_1.__decorate([
    ...
    class_validator_1.IsNotEmpty(),
    tslib_1.__metadata("design:type", String)
], UpdateHubRequest.prototype, "name", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsNotEmpty(),
    tslib_1.__metadata("design:type", String)
], UpdateHubRequest.prototype, "city_id", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Number)
], UpdateHubRequest.prototype, "oms_id", void 0);
tslib_1.__decorate([
    class_validator_1.IsNumber(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Number)
], UpdateHubRequest.prototype, "tax_rate", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHubRequest.prototype, "contact_phone", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHubRequest.prototype, "contact_email", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHubRequest.prototype, "address_street", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHubRequest.prototype, "address_number", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHubRequest.prototype, "address_town", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHubRequest.prototype, "address_zip_code", void 0);
tslib_1.__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", String)
], UpdateHubRequest.prototype, "address_coordinates", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], UpdateHubRequest.prototype, "has_nextmv_enabled", void 0);
tslib_1.__decorate([
    class_validator_1.IsBoolean(),
    class_validator_1.IsOptional(),
    tslib_1.__metadata("design:type", Boolean)
], UpdateHubRequest.prototype, "has_expeditor_app_enabled", void 0);
exports.UpdateHubRequest = UpdateHubRequest;


/***/ }),

/***/ "./apps/service-networkv2/src/utils/common.ts":
/***/ ((__unused_webpack_module, exports) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.httpResponse = exports.generalError = void 0;
...
/***/ "./apps/service-networkv2/src/utils/middlewares/validate-request.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "./apps/service-networkv2/src/utils/util.ts":
/***/ ((__unused_webpack_module, exports) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.httpResponse = exports.parsePaginationParam = void 0;
...
const dbctxInjector = (servicedb, entities) => {
    return (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        try {
            const { conn, repositories } = yield connection_1.getConnection(authorizer_1.getOrigin(req), servicedb, entities);
            req.conn = conn;
...
tslib_1.__decorate([
    core_1.Property({ defaultRaw: `now()`, onCreate: () => new Date(), hidden: true }),
    tslib_1.__metadata("design:type", typeof (_a = typeof Date !== "undefined" && Date) === "function" ? _a : Object)
], BaseEntity.prototype, "created_at", void 0);
tslib_1.__decorate([
    core_1.Property({ onUpdate: () => new Date(), hidden: true }),
...
class CustomEntityRepository extends core_1.EntityRepository {
    ...
    failIfEntityExists(where) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (entityExists) {
                throw new service_sdk_1.ConflictError(`This ${this.entityName.toString()} already exists`);
            }
        });
    }
    softDelete(params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (params.deleteMany && params.deleteOne) {
                throw new service_sdk_1.BadRequestError("You can not pass deleteMany and deleteOne to the soft delete function");
            }
            if (!params.deleteMany && !params.deleteOne) {
                throw new service_sdk_1.BadRequestError("You must pass deleteMany or deleteOne options to the soft delete function");
            }
            if (params.deleteMany) {
                const entitiesToDelete = yield this.findAll(params.deleteMany);
                yield this.persistAndFlush(entitiesToDelete.map((item) => {
                    item.deleted_at = new Date();
                    return item;
                }));
                return true;
            }
            const entityToDelete = yield this.findOne(params.deleteOne);
            if (!entityToDelete) {
                throw new service_sdk_1.NotFoundError(this.entityName.toString());
            }
            entityToDelete.deleted_at = new Date();
            yield this.persistAndFlush(entityToDelete);
            return true;
        });
    }
    failIfEntitiesNotFound(entityIDs) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const uniqueIDs = [...new Set(entityIDs)];
            const foundEntities = yield this.find({ id: { $in: uniqueIDs } });
            if (foundEntities.length !== uniqueIDs.length) {
                throw new service_sdk_1.NotFoundError("Entity", `Some of the ${this.entityName.toString()}s do not exist in the database`);
            }
        });
    }
}
...
tslib_1.__exportStar(__webpack_require__("./libs/service-sdk/db-provider/postgres/native-big-int.ts"), exports);
...
/***/ "./libs/service-sdk/db-provider/postgres/native-big-int.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
class EvClient {
    ...
    publish(topicARN, eventName, context, data, meta) {
        ...
        if (this.stage === 'local') {
            this.client.publish(eventName, JSON.stringify({
...
function getConnectionOptions(customConfig) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        if (customConfig) {
            ...
            return {
                type: 'postgresql',
                dbName: process.env.AURORA_DB_NAME,
...
function createDatabase(config) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (!config.dbName) {
            console.error('AURORA_DB_NAME environment variable missing');
            throw new Error('AURORA_DB_NAME not defined');
        }
        try {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CustomError = exports.ValidationError = exports.NotFoundError = exports.AuthorizationError = exports.BadRequestError = exports.ConflictError = void 0;
...
tslib_1.__exportStar(__webpack_require__("./libs/service-sdk/utils/swagger-init/index.ts"), exports);
...
/***/ "./libs/service-sdk/utils/swagger-init/get-options.ts":
/***/ ((__unused_webpack_module, exports) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getOptions = void 0;
const getOptions = ({ title, description }) => {
    return {
        swagger: '2.0',
        info: {
            version: '1.0',
...
/***/ "./libs/service-sdk/utils/swagger-init/index.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const express = __webpack_require__("express");
const swaggerUiExpress = __webpack_require__("swagger-ui-express");
const shared_1 = __webpack_require__("./libs/shared/index.ts");
const get_options_1 = __webpack_require__("./libs/service-sdk/utils/swagger-init/get-options.ts");
const setup_json_schemas_1 = __webpack_require__("./libs/service-sdk/utils/swagger-init/setup-json-schemas.ts");
const swaggerInit = (app, name) => {
    const { title, description } = shared_1.appsDefinitionLocal[name];
    const mergedOptions = Object.assign(Object.assign({}, get_options_1.getOptions({ title, description })), setup_json_schemas_1.setupJSONSchemas({ name }));
    const swaggerUiExpressOptions = {
        customCss: '.swagger-ui .topbar { display: none }',
        customSiteTitle: title,
        customfavIcon: '',
    };
    app.use(`/api/${name}/docs`, express.static('node_modules/swagger-ui-dist/', { index: false }), swaggerUiExpress.serve, swaggerUiExpress.setup(mergedOptions, swaggerUiExpressOptions));
};
...
/***/ "./libs/service-sdk/utils/swagger-init/setup-json-schemas.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.setupJSONSchemas = void 0;
const fs = __webpack_require__("fs");
const setupJSONSchemas = ({ name }) => {
    const docsPath = process.env.STAGE === 'local' ? `./apps/service-${name}/docs/` : './docs/';
    console.log({ docsPath });
    const pathExists = fs.existsSync(docsPath);
    if (!pathExists) {
        console.warn('Docs folder is missing');
        return;
    }
    const docsFiles = fs.readdirSync(docsPath);
    return docsFiles.reduce((acc, curr) => {
        if (!curr.endsWith('json'))
            return;
        const file = JSON.parse(fs.readFileSync(`${docsPath}${curr}`, {
            encoding: 'utf-8',
        }));
        for (const [key, value] of Object.entries(file)) {
            acc[key] = Object.assign(Object.assign({}, acc[key]), value);
        }
        return acc;
    }, {});
};
exports.setupJSONSchemas = setupJSONSchemas;
...
exports.PERMISSION = {
    "DASHBORD": {
        "CAN_GET_APPS": "permission::dashboard::CAN_GET_APPS",
    },
    "IAM": {
        "CAN_GET_SINGLE_ROLE": "permission::iam::CAN_GET_SINGLE_ROLE",
        "CAN_LIST_ROLES": "permission::iam::CAN_LIST_ROLES",
        "CAN_CREATE_ROLE": "permission::iam::CAN_CREATE_ROLE",
        "CAN_PATCH_ROLE": "permission::iam::CAN_PATCH_ROLE",
        "CAN_DELETE_ROLE": "permission::iam::CAN_DELETE_ROLE",
        "CAN_GET_AUTHENTICATED_USER": "permission::iam::CAN_GET_AUTHENTICATED_USER",
        "CAN_GET_SINGLE_USER": "permission::iam::CAN_GET_SINGLE_USER",
        "CAN_LIST_USERS": "permission::iam::CAN_LIST_USERS",
        "CAN_CREATE_USER": "permission::iam::CAN_CREATE_USER",
        "CAN_CREATE_HOTEL_PARTNER": "permission::iam::CAN_CREATE_HOTEL_PARTNER",
        "CAN_PATCH_USER": "permission::iam::CAN_PATCH_USER",
        "CAN_DELETE_USER": "permission::iam::CAN_DELETE_USER",
        "CAN_GET_APPS": "permission::iam::CAN_GET_APPS",
        "CAN_GET_PERMISSIONS": "permission::iam::CAN_GET_PERMISSIONS",
    },
    "MENU": {
        "CAN_GET_CATEGORIES": "permission::menu::CAN_GET_CATEGORIES",
        "CAN_GET_CATEGORY_RELATIONS": "permission::menu::CAN_GET_CATEGORY_RELATIONS",
        "CAN_GET_CATEGORY": "permission::menu::CAN_GET_CATEGORY",
        "CAN_CREATE_CATEGORY": "permission::menu::CAN_CREATE_CATEGORY",
        "CAN_PATCH_CATEGORY": "permission::menu::CAN_PATCH_CATEGORY",
        "CAN_DELETE_CATEGORY": "permission::menu::CAN_DELETE_CATEGORY",
        "CAN_GET_SUBCATEGORIES": "permission::menu::CAN_GET_SUBCATEGORIES",
        "CAN_GET_SUBCATEGORY": "permission::menu::CAN_GET_SUBCATEGORY",
        "CAN_GET_SUBCATEGORY_RELATIONS": "permission::menu::CAN_GET_SUBCATEGORY_RELATIONS",
        "CAN_CREATE_SUBCCATEGORY": "permission::menu::CAN_CREATE_SUBCCATEGORY",
        "CAN_PATCH_SUBCATEGORY": "permission::menu::CAN_PATCH_SUBCATEGORY",
        "CAN_DELETE_SUBCATEGORY": "permission::menu::CAN_DELETE_SUBCATEGORY",
        "CAN_BATCH_GET_SUBCATEGORIES": "permission::menu::CAN_BATCH_GET_SUBCATEGORIES",
        "CAN_GET_MODIFIERS": "permission::menu::CAN_GET_MODIFIERS",
        "CAN_GET_MODIFIER": "permission::menu::CAN_GET_MODIFIER",
        "CAN_CREATE_MODIFIER": "permission::menu::CAN_CREATE_MODIFIER",
        "CAN_PATCH_MODIFIER": "permission::menu::CAN_PATCH_MODIFIER",
        "CAN_DELETE_MODIFIER": "permission::menu::CAN_DELETE_MODIFIER",
        "CAN_GET_ITEMS_BY_MODIFIER": "permission::menu::CAN_GET_ITEMS_BY_MODIFIER",
        "CAN_GET_PRESIGNED_URL": "permission::menu::CAN_GET_PRESIGNED_URL",
        "CAN_GET_ITEM": "permission::menu::CAN_GET_ITEM",
        "CAN_GET_ITEM_RELATIONS": "permission::menu::CAN_GET_ITEM_RELATIONS",
        "CAN_GET_ITEMS_BY_SUBCATEGORY": "permission::menu::CAN_GET_ITEMS_BY_SUBCATEGORY",
        "CAN_GET_ITEMS_BY_CATEGORY": "permission::menu::CAN_GET_ITEMS_BY_CATEGORY",
        "CAN_CREATE_ITEM": "permission::menu::CAN_CREATE_ITEM",
        "CAN_PATCH_ITEM": "permission::menu::CAN_PATCH_ITEM",
        "CAN_GET_CATEGORIZED_ITEMS": "permission::menu::CAN_GET_CATEGORIZED_ITEMS",
        "CAN_DELETE_ITEM": "permission::menu::CAN_DELETE_ITEM",
        "CAN_GET_ITEMS": "permission::menu::CAN_GET_ITEMS",
        "CAN_GET_MENUS": "permission::menu::CAN_GET_MENUS",
        "CAN_GET_SINGLE_MENU": "permission::menu::CAN_GET_SINGLE_MENU",
        "CAN_CREATE_MENU": "permission::menu::CAN_CREATE_MENU",
        "CAN_UPDATE_MENU": "permission::menu::CAN_UPDATE_MENU",
        "CAN_DUPLICATE_MENU": "permission::menu::CAN_DUPLICATE_MENU",
        "CAN_DELETE_MENU": "permission::menu::CAN_DELETE_MENU",
        "CAN_BATCH_EDIT_MENU": "permission::menu::CAN_BATCH_EDIT_MENU",
        "CAN_GET_MENU_HOTELS": "permission::menu::CAN_GET_MENU_HOTELS",
        "CAN_GET_ALL_HOTELS": "permission::menu::CAN_GET_ALL_HOTELS",
        "CAN_ASSIGN_MENU": "permission::menu::CAN_ASSIGN_MENU",
        "CAN_PUSH_MENU_TO_PRODUCTION": "permission::menu::CAN_PUSH_MENU_TO_PRODUCTION",
    },
    "NETWORK": {
        "CAN_GET_CITIES": "permission::network::CAN_GET_CITIES",
        "CAN_GET_CITY": "permission::network::CAN_GET_CITY",
        "CAN_CREATE_CITY": "permission::network::CAN_CREATE_CITY",
        "CAN_UPDATE_CITY": "permission::network::CAN_UPDATE_CITY",
        "CAN_DELETE_CITY": "permission::network::CAN_DELETE_CITY",
        "CAN_GET_HOTELS": "permission::network::CAN_GET_HOTELS",
        "CAN_GET_HOTEL": "permission::network::CAN_GET_HOTEL",
        "CAN_CREATE_HOTEL": "permission::network::CAN_CREATE_HOTEL",
        "CAN_CREATE_HOTEL_SF": "permission::network::CAN_CREATE_HOTEL_SF",
        "CAN_UPDATE_HOTEL": "permission::network::CAN_UPDATE_HOTEL",
        "CAN_UPDATE_HOTEL_INTEGRATION_CONFIGS_SHUTTLE_APP": "permission::network::CAN_UPDATE_HOTEL_INTEGRATION_CONFIGS_SHUTTLE_APP",
        "CAN_UPDATE_HOTEL_PAYMENTS": "permission::network::CAN_UPDATE_HOTEL_PAYMENTS",
        "CAN_UPDATE_HOTEL_INTEGRATION_CONFIGS_PMS": "permission::network::CAN_UPDATE_HOTEL_INTEGRATION_CONFIGS_PMS",
        "CAN_UPDATE_HOTEL_INTEGRATION_CONFIGS_ACTIVITIES_APP": "permission::network::CAN_UPDATE_HOTEL_INTEGRATION_CONFIGS_ACTIVITIES_APP",
        "CAN_UPDATE_HOTEL_INTEGRATION_CONFIGS_MENU_APP": "permission::network::CAN_UPDATE_HOTEL_INTEGRATION_CONFIGS_MENU_APP",
        "CAN_UPDATE_HOTEL_INTEGRATION_CONFIGS_VOUCHERS_APP": "permission::network::CAN_UPDATE_HOTEL_INTEGRATION_CONFIGS_VOUCHERS_APP",
        "CAN_CHANGE_HOTEL_STATUS": "permission::network::CAN_CHANGE_HOTEL_STATUS",
        "CAN_DELETE_HOTELS": "permission::network::CAN_DELETE_HOTELS",
        "CAN_GET_HUBS": "permission::network::CAN_GET_HUBS",
        "CAN_GET_HUB": "permission::network::CAN_GET_HUB",
        "CAN_CREATE_HUB": "permission::network::CAN_CREATE_HUB",
        "CAN_UPDATE_HUB": "permission::network::CAN_UPDATE_HUB",
        "CAN_DEACTIVATE_HUB": "permission::network::CAN_DEACTIVATE_HUB",
        "CAN_DELETE_HUB": "permission::network::CAN_DELETE_HUB",
    },
    "VOUCHER": {
        "CAN_GET_HOTELS_WITH_VOUCHERS": "permission::voucher::CAN_GET_HOTELS_WITH_VOUCHERS",
        "CAN_GET_HOTEL_VOUCHER_CODES": "permission::voucher::CAN_GET_HOTEL_VOUCHER_CODES",
        "CAN_GENERATE_VOUCHER_CODES": "permission::voucher::CAN_GENERATE_VOUCHER_CODES",
        "CAN_GET_SINGLE_VOUCHER_PROGRAM": "permission::voucher::CAN_GET_SINGLE_VOUCHER_PROGRAM",
        "CAN_LIST_VOUCHER_PROGRAMS": "permission::voucher::CAN_LIST_VOUCHER_PROGRAMS",
        "CAN_CREATE_VOUCHER_PROGRAM": "permission::voucher::CAN_CREATE_VOUCHER_PROGRAM",
        "CAN_UPDATE_VOUCHER_PROGRAMS": "permission::voucher::CAN_UPDATE_VOUCHER_PROGRAMS",
        "CAN_DELETE_VOUCHER_PROGRAMS": "permission::voucher::CAN_DELETE_VOUCHER_PROGRAMS",
    },
};
...
const createCityValidator = yup
    ...
    .shape({
    name: yup.string().required("Name is a required field!"),
    time_zone: yup.string().required("Timezone is a required field!"),
...
const createHubValidator = yup
    ...
    contact_email: yup.string().required("Contact email is a required field!"),
...
const core_1 = __webpack_require__("@mikro-orm/core");
const shared_1 = __webpack_require__("./libs/shared/index.ts");
const route_1 = __webpack_require__("./apps/service-networkv2/src/hub/route.ts");
const route_2 = __webpack_require__("./apps/service-networkv2/src/hotel/route.ts");
const route_3 = __webpack_require__("./apps/service-networkv2/src/city/route.ts");
const entity_1 = __webpack_require__("./apps/service-networkv2/src/city/entity.ts");
const entity_2 = __webpack_require__("./apps/service-networkv2/src/hub/entity.ts");
const entity_3 = __webpack_require__("./apps/service-networkv2/src/hotel/entity.ts");
const app = express();
const jsonParser = bodyParser.json();
app.use(service_sdk_1.dbctxInjector(process.env.DB, [entity_1.default, entity_2.default, entity_3.default]));
app.use(cors());
app.use(jsonParser);
app.use((req, res, next) => {
    core_1.RequestContext.create(req.conn.em, next);
});
...
if (process.env.STAGE === "local") {
    service_sdk_1.expressLocal(app, shared_1.AppEnum.NETWORKV2);
